...
tellraw @a ["",{"text":"ProjectUI","color":"white"},{"text":"> ","color":"green"},{"text":"現在のバージョンは","color":"gray"},{"text":" 46 ","color":"aqua"},{"text":"です","color":"gray"}]
...
#=====================================================================================
    ...
    scoreboard players set $version ui_world 46
    #say operationed