...
# ベンチマーク
#give @p minecraft:carrot_on_a_stick{tmw:{id:237,enableQ:1,enableF:1,gun:{Name:"alpha:50ms",BurstType:1,Burst:3,BurstMax:-1,ShotCT:1,BurstCT:20,SubType:101,SPType:101,SPNeed:300,InkMax:1000,MainInkUse:1,SubInkUse:1,MoveInkRegen:30,ShootInkRegen:6,now:{Ink:1000,CT:0,Burst:0,SP:0,SPTime:0}},main:{Spread:0,AirSpread:300,Speed:50,SpeedPlus:0,RangeType:1,Range:300,FlyParticle:6,EndParticle:5,Damage:70,MultiShot:10,ShotFootStep:1,Sound:1}},display:{Lore:['[{"text":"軽量のインクをばら撒く","color":"gray","italic":false}]']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.1,Operation:1,UUID:[I;2,2,1,1],Slot:"mainhand"}]}
#give @p minecraft:carrot_on_a_stick{tmw:{id:237,enableQ:1,enableF:1,gun:{Name:"beta:100ms",BurstType:1,Burst:1,BurstMax:-1,ShotCT:1,BurstCT:20,SubType:101,SPType:101,SPNeed:300,InkMax:1000,MainInkUse:1,SubInkUse:1,MoveInkRegen:30,ShootInkRegen:6,now:{Ink:1000,CT:0,Burst:0,SP:0,SPTime:0}},main:{Spread:0,AirSpread:300,Speed:50,SpeedPlus:0,RangeType:1,Range:300,FlyParticle:6,EndParticle:5,Damage:70,MultiShot:50,ShotFootStep:1,Sound:1}},display:{Lore:['[{"text":"軽量のインクをばら撒く","color":"gray","italic":false}]']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.1,Operation:1,UUID:[I;2,2,1,1],Slot:"mainhand"}]}

give @p minecraft:carrot_on_a_stick{tmw:{id:251},display:{Name:'[{"text":"マップエディター","color":"white","italic":false}]',Lore:['{"text":"右クリックで操作","color":"gold","italic":false}']},HideFlags:4}
