...
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run setblock ~-2 ~ ~ structure_block{powered:0b,showboundingbox:1b,mode:"LOAD",posX:-29,posY:0,posZ:0,sizeX:31,sizeY:31,sizeZ:32,name:"ui:sphere63/npp"}
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run setblock ~-2 ~ ~-1 structure_block{powered:0b,showboundingbox:1b,mode:"LOAD",posX:-29,posY:0,posZ:-30,sizeX:31,sizeY:31,sizeZ:31,name:"ui:sphere63/nnp"}
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run setblock ~ ~-1 ~ structure_block{powered:0b,showboundingbox:1b,mode:"LOAD",posX:0,posY:-31,posZ:0,sizeX:32,sizeY:32,sizeZ:32,name:"ui:sphere63/ppn"}
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run setblock ~ ~-1 ~-1 structure_block{powered:0b,showboundingbox:1b,mode:"LOAD",posX:0,posY:-31,posZ:-30,sizeX:32,sizeY:32,sizeZ:31,name:"ui:sphere63/pnn"}
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run setblock ~-2 ~-1 ~ structure_block{powered:0b,showboundingbox:1b,mode:"LOAD",posX:-29,posY:-31,posZ:0,sizeX:31,sizeY:32,sizeZ:32,name:"ui:sphere63/npn"}
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run setblock ~-2 ~-1 ~-1 structure_block{powered:0b,showboundingbox:1b,mode:"LOAD",posX:-29,posY:-31,posZ:-30,sizeX:31,sizeY:32,sizeZ:31,name:"ui:sphere63/nnn"}
...
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run execute at @s run fill ~1 ~ ~ ~1 ~-1 ~-1 redstone_block
execute as @s[scores={ui_calc1=24}] if score $temp ui_temp matches 1 at @s run execute at @s run fill ~-1 ~ ~ ~-1 ~-1 ~-1 redstone_block
