...
#動作が進んだらアイテムを産出
    execute as @s[tag=ui_i_crafted] run function ui:industry/6/craft
...
#GUI描画
    execute if entity @s[scores={ui_i_gui=2}] run function ui:industry/6/gui
...
#土台壊されたら破壊
    ...
    execute if entity @s[tag=ui_i_break] run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stray_spawn_egg",Count:1b,tag:{CustomModelData:130006,display:{Name:'{"text":"圧縮機","italic":false,"color":"dark_green"}',Lore:['[{"text":"電気を使ってアイテムを圧縮する","color":"gray","italic":false}]','[{"text":"消費電力：4SU/t","color":"gray","italic":false}]','[{"text":"送電速度：5SU/t","color":"gray","italic":false}]','[{"text":"蓄電量：2000SU","color":"gray","italic":false}]']},EntityTag:{id:"minecraft:bat",Silent:1b,NoAI:1b,Tags:["ui_egg_i","ui_egg_i_6"]}}}}
