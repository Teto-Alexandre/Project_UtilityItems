...
#土台壊されたら破壊
    ...
    execute if entity @s[tag=ui_i_break] run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stray_spawn_egg",Count:1b,tag:{CustomModelData:130005,display:{Name:'{"text":"高速電気かまど","italic":false,"color":"dark_green"}',Lore:['[{"text":"電気を使って五倍速で精錬する","color":"gray","italic":false}]','[{"text":"消費電力：8SU/t","color":"gray","italic":false}]','[{"text":"送電速度：5SU/t","color":"gray","italic":false}]','[{"text":"蓄電量：8000SU","color":"gray","italic":false}]']},EntityTag:{id:"minecraft:bat",Silent:1b,NoAI:1b,Tags:["ui_egg_i","ui_egg_i_5"]}}}}
