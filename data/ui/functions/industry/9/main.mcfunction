...
#動作が進んだらアイテムを産出
    execute as @s[tag=ui_i_crafted] run function ui:industry/9/craft
...
#GUI描画
    execute if entity @s[scores={ui_i_gui=2}] run function ui:industry/9/gui
    
#土台壊されたら破壊
    execute as @s[tag=ui_i_break] run function ui:industry/9/break
