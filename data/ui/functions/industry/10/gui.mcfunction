...
#レシピ情報をもとに完成品スロットの見た目を設定
    ...
    execute at @s[scores={ui_i_recipe=21}] run data modify entity @s ArmorItems[3].tag.ui.Item set value {id:"minecraft:command_block",Count:1b,Slot:15b,tag:{tmw:{id:1017},CustomModelData:191002,display:{Name:'{"text":"黒穹の断片","color":"green","italic":false}'}}}
    execute at @s[scores={ui_i_recipe=22}] run data modify entity @s ArmorItems[3].tag.ui.Item set value {id:"minecraft:command_block",Count:1b,Slot:15b,tag:{tmw:{id:1018},CustomModelData:191003,display:{Name:'{"text":"黒穹インゴット","color":"green","italic":false}'}}}
