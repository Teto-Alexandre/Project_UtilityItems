...
#完成品を渡す
give @s splash_potion{display:{Name:'[{"text":"嫉妬","color":"#660099","bold":true,"italic":false},{"text":"と","color":"#007700","bold":true,"italic":true},{"text":"悪意","color":"#663333","bold":true,"italic":false},{"text":"の凬","color":"#007700","bold":true,"italic":true}]'},HideFlags:32,CustomPotionEffects:[{Id:19,Amplifier:4b,Duration:600,ShowParticles:0b},{Id:27,Amplifier:4b,Duration:600,ShowParticles:0b}],CustomPotionColor:30464}
