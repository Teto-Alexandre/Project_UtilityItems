...
#完成品を渡す
give @s splash_potion{display:{Name:'[{"text":"歓喜","color":"#CC0000","bold":true,"italic":false},{"text":"と","color":"#996600","bold":true,"italic":true},{"text":"狂乱","color":"#CCCCCC","bold":true,"italic":false},{"text":"の凬","color":"#996600","bold":true,"italic":true}]'},HideFlags:32,CustomPotionEffects:[{Id:17b,Amplifier:50b,Duration:600,ShowParticles:0b},{Id:20b,Amplifier:1b,Duration:600,ShowParticles:0b}],CustomPotionColor:10053120}
