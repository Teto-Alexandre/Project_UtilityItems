...
# スロットが空白ならボタンが押されたと判断する＋changedを1に
    ...
    execute if score $slot ui_temp matches 2 run scoreboard players set $sp ui_temp 202
    execute if score $slot ui_temp matches 3 run scoreboard players set $sp ui_temp 301
