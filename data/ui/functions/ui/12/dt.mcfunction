...
execute if score $temp7 ui_temp matches 1 run tellraw @a[distance=..25] [{"color":"gray","text":"damage"},{"color":"green","text":"> "},{"color":"gray","text":"============ Record Started ============"}]
execute unless score $temp2 ui_temp matches 1.. run tellraw @a[distance=..25] [{"color":"gray","text":"damage"},{"color":"green","text":"> "},{"score":{"name":"$temp","objective":"ui_temp"},"color":"gold"},{"color":"gold","text":"."},{"score":{"name":"$temp4","objective":"ui_temp"},"color":"gold"},{"color":"gray","text":" ⇒ [ "},{"score":{"name":"$temp5","objective":"ui_temp"},"color":"gold"},{"color":"gold","text":"."},{"score":{"name":"$temp6","objective":"ui_temp"},"color":"gold"},{"color":"gray","text":"damage , "},{"score":{"name":"$temp7","objective":"ui_temp"},"color":"gold"},{"color":"gray","text":"Combo ]"}]
