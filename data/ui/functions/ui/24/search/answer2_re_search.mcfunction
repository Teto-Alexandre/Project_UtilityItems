...
data modify storage ui:ui23_template_answer temp set from storage ui:dimensional_search list
#data modify storage ui:dimensional_search list_old set from storage ui:dimensional_search list
...
#data modify storage ui:ui23_template_answer temp set from storage ui:dimensional_search list_old
#data remove storage ui:dimensional_search list_old
...
function ui:ui/23/template/answer/re_all