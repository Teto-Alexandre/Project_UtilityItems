# ダメージ計測 and 再設置
execute if entity @s[tag=ui_24_1_rot1] store result score $temp ui_temp at @s run fill ~ ~ ~1 ~ ~ ~1 chest[facing=west,type=left]{CustomName:'{"italic": false,"bold": true,"text":"アクセスチェスト"}'} hollow
