...
# ページ管理  
data modify storage ui:temp temp set from storage ui:access_chest Items
...
execute if score $slot_res ui_temp matches 0.. run data modify storage ui:temp temp set from storage ui:access_chest Items
...
# 保存
data modify storage ui:access_chest Items_Right set from block ~ ~ ~ Items
data modify storage ui:access_chest Items_Left set from block ^ ^ ^1 Items
