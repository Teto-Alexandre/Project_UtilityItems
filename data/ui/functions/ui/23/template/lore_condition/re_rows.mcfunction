...
data modify storage ui:temp name_condition.name set from storage ui:ui23_template_answer temp[0].tag.display.Lore[0]
...
data remove storage ui:ui23_template_answer temp[0].tag.display.Lore[0]

execute if score $name_condition_check_all ui_temp matches 1 if score $name_condition_rows ui_temp matches 1.. run function ui:ui/23/template/lore_condition/re_rows
