...
data modify storage ui:temp name_condition.name set from storage ui:ui23_template_answer temp[0][0][0][0].tag.tmw.cg.cost
execute if data storage ui:ui23_template_answer temp[0][0][0][0].tag.tmw.cg.cost.amount run data modify storage ui:temp name_condition.name set from storage ui:ui23_template_answer temp[0][0][0][0].tag.tmw.cg.cost.amount
execute store result score $name_condition_length ui_temp run data get storage ui:temp name_condition.name
execute unless data storage ui:ui23_template_answer temp[0][0][0][0].tag.tmw.cg.cost run scoreboard players set $name_condition_length ui_temp 0
