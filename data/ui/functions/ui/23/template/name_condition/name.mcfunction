...
function ui:ui/23/template/name_condition/macro with storage ui:temp name_condition.macro
...
execute if score $name_condition_check ui_temp matches 1 if score $name_condition_inv ui_temp <= $name_condition_length ui_temp run function ui:ui/23/template/name_condition/name
