...
function ui:ui/23/template/name_condition/name
...
execute if score $name_condition_check ui_temp matches 1 if score $name_condition_rows ui_temp matches 1.. run function ui:ui/23/template/name_condition/rows
