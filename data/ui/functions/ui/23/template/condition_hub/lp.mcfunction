...
#
data modify storage ui:ui23_template_answer temp[0][0][0][0] set from storage ui:ui23_template_answer_temp _
...
execute if data storage ui:ui23_template_answer Name_temp[0] run function ui:ui/23/template/condition_hub/lp
