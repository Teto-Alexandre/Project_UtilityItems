...
# 破壊されたら中身ごと復活
execute if block ~ ~ ~ #ui:nocol run function ui:ui/22/dt_right
...
# ページ管理
data modify storage ui:temp temp set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Items
#tellraw @a [{"storage":"oh_my_dat:","nbt":"_[-4][-4][-4][-4][-4][-4][-4][-4].Items"}]
execute if score $slot_res ui_temp matches 0.. if score $temp ui_temp matches 2.. run function ui:ui/22/menu/extract
execute if score $slot_res ui_temp matches 0.. run data modify storage ui:temp temp_trim set from storage ui:temp temp[0]
execute if score $slot_res ui_temp matches 0.. if score $temp2 ui_temp matches 1.. run function ui:ui/22/each/extract
execute if score $slot_res ui_temp matches 0.. if score $temp2 ui_temp matches 0 run function ui:ui/22/each/push
execute if score $slot_res ui_temp matches 0.. run function ui:ui/22/click
#execute if score $slot_res ui_temp matches 0.. run tellraw @a [{"storage":"oh_my_dat:","nbt":"_[-4][-4][-4][-4][-4][-4][-4][-4].Items"}]
execute if score $slot_res ui_temp matches 0.. run data modify storage ui:temp temp set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Items
...
execute if score $slot_res ui_temp matches 0.. if score $temp ui_temp matches 2.. run function ui:ui/22/menu/extract
execute if score $slot_res ui_temp matches 0.. if score $temp2 ui_temp matches -1 run function ui:ui/22/menu/1
execute if score $slot_res ui_temp matches 0.. if score $temp2 ui_temp matches 1.. run function ui:ui/22/each/extract
execute if score $slot_res ui_temp matches 0.. if score $temp2 ui_temp matches 0 run function ui:ui/22/each/1
...
# 近くでしゃがむと消滅
execute if entity @a[distance=..2,scores={ui_st2=10..},gamemode=!adventure,gamemode=!spectator] run function ui:ui/22/st
