...
scoreboard players remove $ui22 ui_world 1
...
kill @s
kill @e[type=item,sort=nearest,limit=2,nbt={Item:{id:"minecraft:chest",tag:{display:{Name:'{"bold":true,"italic":false,"text":"亜空間マルチページチェスト"}'}}}}]