...
# インク残量
scoreboard players operation #calc2 temp = @s count
scoreboard players operation #calc2 temp /= #100 ui_num
...
data modify entity @e[tag=ui_template_text_board,limit=1] Item.tag.display.Lore append value '{"text":"秒. 金:","color":"gray","italic":false}'
data modify entity @e[tag=ui_template_text_board,limit=1] Item.tag.display.Lore append value '{"score":{"name":"#calc2","objective":"temp"},"color":"yellow"}'
