...
scoreboard players operation $rand ui_calc1 %= #10000 ui_num
scoreboard players operation $x1 ui_calc1 += $rand ui_calc1
scoreboard players remove $x1 ui_calc1 5000
...
scoreboard players remove $y1 ui_calc1 5000
...
scoreboard players remove $z1 ui_calc1 5000
