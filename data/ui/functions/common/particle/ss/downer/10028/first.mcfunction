...
execute unless entity @s[tag=ui_temp_boost] at @e[tag=ui_temp_target] facing entity @s feet run teleport @s ^ ^ ^7.5
execute if entity @s[tag=ui_temp_boost] at @e[tag=ui_temp_target] facing entity @s feet run teleport @s ^ ^ ^15
