...
execute if entity @s[tag=ui_temp_hit] as @e[predicate=ui:load_unhurtable,tag=!ui_temp_teamm,sort=nearest,limit=1] at @s run function ui:common/particle/ss/downer/10027/damage1
