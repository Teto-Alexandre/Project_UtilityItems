...
execute if entity @s[tag=ui_temp_boost] at @s unless block ~ ~ ~ #ui:nocol run function ui:common/particle/ss/downer/10035/laser/boost_reflect
execute if score $count ui_temp matches 1.. unless entity @s[tag=ui_temp_hit] at @s if block ~ ~ ~ #ui:nocol run function ui:common/particle/ss/downer/10035/laser/move.lp
