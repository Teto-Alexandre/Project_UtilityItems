...
data merge storage tds: {Damage:40.00,DamageType:1,DeathMessage:16,WeaponName:'[{"text":"メテオストライク","color":"white","italic":"false"}]',EPF:-1,BypassArmor:0,BypassResistance:false}
function tds:attack
