#
    execute rotated ~ 0 run function ui:common/particle/ss/downer/10001/1

#
    #say @e[predicate=ui:load_unhurtable,tag=!ui_temp_team]
    execute as @e[distance=..4,predicate=ui:load_unhurtable,tag=!ui_temp_team] at @s run function ui:common/particle/ss/downer/10001/damage

playsound entity.generic.explode player @a ~ ~ ~ 1 2 0
particle electric_spark ~ ~0.500 ~ 1.5 0 1.5 0 25 force @a
particle dust 1 1 0.5 1 ~ ~0.500 ~ 1.5 0 1.5 0 25 force @a
