#
execute if score $is ui_temp matches 1 run function ui:common/particle/ss/downer/10030/first
...
execute if score $is ui_temp matches 11 run function ui:common/particle/ss/downer/10030/flash
