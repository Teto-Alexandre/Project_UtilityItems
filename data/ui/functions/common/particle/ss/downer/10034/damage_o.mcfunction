...
data merge storage tds: {temp:{Damage:8.00,DamageType:1,DeathMessage:9,WeaponName:'[{"text":"老いた少年工房","color":"white","italic":"false"}]',EPF:-1,BypassArmor:0,BypassResistance:false}}
