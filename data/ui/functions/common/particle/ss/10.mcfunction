...
#
execute if score $is ui_temp matches 1.. run function ui:common/particle/ss/10/animate
execute if score $is ui_temp matches 1.. rotated ~90 ~ run function ui:common/particle/ss/10/animate
execute if score $is ui_temp matches 1.. rotated ~180 ~90 run function ui:common/particle/ss/10/animate
execute if score $is ui_temp matches 1.. rotated ~-90 ~-90 run function ui:common/particle/ss/10/animate
...
execute if score $is ui_temp matches 7 if score $temp ui_temp matches 1 positioned ~-0.5 ~0.5 ~0.5 unless block ~ ~ ~ #ui:nobreak unless block ~ ~ ~ #ui:super_hard unless block ~ ~ ~ #ui:liq run setblock ~ ~ ~ air destroy
execute if score $is ui_temp matches 7 if score $temp ui_temp matches 1 positioned ~0.5 ~0.5 ~0.5 unless block ~ ~ ~ #ui:nobreak unless block ~ ~ ~ #ui:super_hard unless block ~ ~ ~ #ui:liq run setblock ~ ~ ~ air destroy
execute if score $is ui_temp matches 7 as @e[distance=..2.5,predicate=ui:load_unhurtable] at @s run function ui:common/particle/ss/10/explode
