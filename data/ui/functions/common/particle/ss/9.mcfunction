...
execute if score $is ui_temp matches 34..35 positioned ^ ^ ^0.5 run function ui:common/particle/ss/9.4
...
execute if score $is ui_temp matches 38..40 positioned ^ ^ ^ run function ui:common/particle/ss/9.2
