...
summon marker ^ ^ ^1.5 {Tags:["ui_temp_particle"]}
execute as @e[tag=ui_temp_particle,limit=1] run function ui:template/square_shuffle
execute if score $is ui_temp matches 1.. facing entity @e[tag=ui_temp_particle,limit=1] feet run particle firework ~ ~ ~ ^ ^ ^100000 0.000009 0 force
kill @e[tag=ui_temp_particle]
summon marker ^ ^ ^1.5 {Tags:["ui_temp_particle"]}
execute as @e[tag=ui_temp_particle,limit=1] run function ui:template/square_shuffle
execute if score $is ui_temp matches 1.. facing entity @e[tag=ui_temp_particle,limit=1] feet run particle firework ~ ~ ~ ^ ^ ^100000 0.000009 0 force
kill @e[tag=ui_temp_particle]
particle dust 1 0.8 0 2 ~ ~ ~ 0.6 0.6 0.6 0 20 force
