#> ui:common/particle/create/square_shuffle
#
# 軽量化用：@s を 立法座標拡散する
#
# @public

scoreboard players operation $rand/2 ui_temp = $rand ui_temp
scoreboard players operation $rand/2 ui_temp /= #2 ui_num
...
scoreboard players operation $rand ui_calc1 %= $rand ui_temp
scoreboard players operation $x1 ui_calc1 += $rand ui_calc1
scoreboard players operation $x1 ui_calc1 -= $rand/2 ui_temp
...
scoreboard players operation $y1 ui_calc1 -= $rand/2 ui_temp
...
scoreboard players operation $z1 ui_calc1 -= $rand/2 ui_temp
