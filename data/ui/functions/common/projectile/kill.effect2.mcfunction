...
# ヒットパーティクル
    ...
    execute if score @s ui_hpart matches 6 at @e[distance=..3,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:common/projectile/hit.marker
    ...
    execute if score @s ui_hpart matches 7 at @e[distance=..4,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:common/projectile/hit.marker
    ...
    execute if score @s ui_hpart matches 16 at @e[distance=..3,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:common/projectile/hit.marker
    ...
    execute if score @s ui_hpart matches 17 at @e[distance=..4,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:common/projectile/hit.marker
