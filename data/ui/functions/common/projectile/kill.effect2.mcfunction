...
# ヒットパーティクル
    ...
    execute if score @s ui_hpart matches 6 run function ui:template/sphere_particle/3.2
    ...
    execute if score @s ui_hpart matches 6 run scoreboard players set @s ui_dmg 4
    execute if score @s ui_hpart matches 6 at @e[distance=..3,tag=!ui_temp_team,type=!#ui:unhurtable,tag=!ui_unhurtable] run function ui:common/projectile/hit.marker
    ...
    execute if score @s ui_hpart matches 7 run scoreboard players set @s ui_dmg 8
    execute if score @s ui_hpart matches 7 at @e[distance=..4,tag=!ui_temp_team,type=!#ui:unhurtable,tag=!ui_unhurtable] run function ui:common/projectile/hit.marker
    ...
    execute if score @s ui_hpart matches 16 run function ui:template/sphere_particle/3.2
    ...
    execute if score @s ui_hpart matches 16 run scoreboard players set @s ui_dmg 4
    execute if score @s ui_hpart matches 16 at @e[distance=..3,tag=!ui_temp_team,type=!#ui:unhurtable,tag=!ui_unhurtable] run function ui:common/projectile/hit.marker
    ...
    execute if score @s ui_hpart matches 17 run scoreboard players set @s ui_dmg 8
    execute if score @s ui_hpart matches 17 at @e[distance=..4,tag=!ui_temp_team,type=!#ui:unhurtable,tag=!ui_unhurtable] run function ui:common/projectile/hit.marker
