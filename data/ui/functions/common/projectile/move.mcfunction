...
#見た目
    ...
    execute if score @s ui_bpart matches 6 store result score $temp ui_temp run fill ~0.3 ~ ~0.3 ~-0.3 ~-7 ~-0.3 light_blue_wool replace #ui:wools
    ...
    execute if score @s ui_bpart matches 16 store result score $temp ui_temp run fill ~0.3 ~ ~0.3 ~-0.3 ~-7 ~-0.3 pink_wool replace #ui:wools
    execute if score @s ui_bpart matches 4..6 run scoreboard players operation $id ui_temp = @s ui_id
    execute if score @s ui_bpart matches 4..6 as @a if score @s ui_id = $id ui_temp run scoreboard players operation @s ui_paint += $temp ui_temp
    execute if score @s ui_bpart matches 14..16 run scoreboard players operation $id ui_temp = @s ui_id
    execute if score @s ui_bpart matches 14..16 as @a if score @s ui_id = $id ui_temp run scoreboard players operation @s ui_paint += $temp ui_temp
