#> ui:tmw/270/ss/eo/idc
#
# #タレットを管理する
#
# @within function ui:tmw/270/ss/tec
...
execute as @e[tag=ui_temp_id_control] at @s run function ui:tmw/270/ss/core
...
# 再帰
execute if entity @e[tag=ui_idc] as @e[limit=1,tag=ui_temp_team_control,tag=ui_idc] run function ui:tmw/270/ss/eo/idc
