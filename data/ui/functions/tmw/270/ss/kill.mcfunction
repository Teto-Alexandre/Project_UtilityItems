# スキルツリーメーカーアクティベート
    ...
    scoreboard players remove $tmw270 ui_temp 1
    tellraw @a [{"text":"JointGear","color": "gray"},{"text": "> ","color": "green"},{"text":"世界タレット数が","color": "gray"},{"score":{"name": "$tmw270","objective": "ui_temp"},"color": "aqua"},{"text":"になりました","color": "gray"}]
