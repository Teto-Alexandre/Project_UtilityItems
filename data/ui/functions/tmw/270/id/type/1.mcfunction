...
#
execute if score $TurretPlace ui_temp matches 1 run summon iron_golem ~ ~ ~ {Tags:["tmw_270","tmw_270_hitbox","ui_temp_this","tds_nolog"],NoAI:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:20000,show_particles:false}],DeathLootTable:"none",Attributes:[{Name:"generic.max_health",Base:1000}],Health:1000f,Silent:1}
...
execute if score $TurretPlace ui_temp matches 2 positioned ~ ~-1 ~ run summon iron_golem ~ ~0.3 ~ {Tags:["tmw_270","tmw_270_ud","tmw_270_hitbox","ui_temp_this","tds_nolog"],NoAI:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:20000,show_particles:false}],DeathLootTable:"none",Attributes:[{Name:"generic.max_health",Base:1000}],Health:1000f,Silent:1}
