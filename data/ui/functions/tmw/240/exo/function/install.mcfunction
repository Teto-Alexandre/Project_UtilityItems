...
# 前提条件が一つでもかけていれば弾く
    ...
    #条件ごとに実行する
        ...
        execute if score $needtotal ui_temp matches 1.. run function ui:tmw/240/exo/needed_checker/list_master
...
# 既に同じ数値を持っていたら弾く
    ...
    #コアのスキルごとに照合
        function ui:tmw/240/exo/double_checker/liner_search
    #コアのスキルリストを削除
