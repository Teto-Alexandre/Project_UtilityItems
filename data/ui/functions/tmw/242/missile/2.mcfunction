...
execute as @s[tag=ex] at @s run summon firework_rocket ~ ~ ~ {Life:0,LifeTime:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[I;16711680,16756224,16514816],FadeColors:[I;16777215]}]}}}}
execute as @s[tag=ex] at @s run function ui:tmw/242/missile/2.2
execute as @s[tag=ex] at @s run function ui:tmw/242/missile/2.2
execute as @s[tag=ex] at @s run function ui:tmw/242/missile/2.2
execute as @s[tag=ex] at @s run function ui:tmw/242/missile/2.2
execute as @s[tag=ex] at @s run function ui:tmw/242/missile/2.2
