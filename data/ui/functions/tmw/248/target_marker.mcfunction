...
execute at @s facing entity @e[tag=ui_temp_this] feet positioned ^ ^ ^1 facing entity @s feet positioned as @e[tag=ui_temp_this] positioned ^ ^ ^2.5 run summon marker ~ ~ ~ {Tags:["ui_temp_marker","ui_temp_marker_unpower"]}
