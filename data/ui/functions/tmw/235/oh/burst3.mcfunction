# 離すと書き込み
    ...
    execute if score $burst ui_temp matches 0 if score $cooltime ui_temp matches 0 if score $ammo ui_temp matches 0.. as @s[tag=tmw_use_c] run function ui:tmw/235/oh/burst3.2
