...
execute if score $type ui_temp matches 108 run scoreboard players set $w.ink ui_temp 750
...
# クールタイム
execute if score $type ui_temp matches 101..500 run scoreboard players set $w.ct ui_temp 3
...
execute if score $type ui_temp matches 252 run scoreboard players set $w.ct ui_temp 6
