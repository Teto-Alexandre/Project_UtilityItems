...
execute if score $subtype ui_temp matches 452 run data modify storage ui:gun temp set value {Name:'{"text":"マルチミサイル","color":"gold"}',TimeUse:14,ShotType:1,ShotCT:1,BurstCT:5,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:10,SpeedPlus:0,RangeType:1,Range:10,FlyParticle:102,EndParticle:102,Damage:0,MultiShot:1,ShotFootStep:0,Sound:2}
execute if score $subtype ui_temp matches 453 run data modify storage ui:gun temp set value {Name:'{"text":"トライアングル","color":"gold"}',TimeUse:1,ShotType:1,ShotCT:1,BurstCT:4,Spread:1200,AirSpread:400,SpreadType:2,AirSpreadType:1,Speed:15,SpeedPlus:15,RangeType:3,Range:70,FlyParticle:6,EndParticle:2,Damage:55,MultiShot:3,ShotFootStep:3,Sound:2}
...
execute if score $subtype ui_temp matches 455 run data modify storage ui:gun temp set value {Name:'{"text":"ジェットパック","color":"gold"}',TimeUse:0,ShotType:1,ShotCT:7,BurstCT:14,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:40,SpeedPlus:0,RangeType:1,Range:80,FlyParticle:4,EndParticle:204,Damage:200,MultiShot:1,ShotFootStep:0,Sound:3}
execute if score $subtype ui_temp matches 456 run data modify storage ui:gun temp set value {Name:'{"text":"バウンシーボム","color":"gold"}',TimeUse:60,ShotType:1,ShotCT:8,BurstCT:16,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:10,SpeedPlus:0,RangeType:2,Range:80,FlyParticle:104,EndParticle:204,Damage:200,MultiShot:1,ShotFootStep:1,Sound:4}
execute if score $subtype ui_temp matches 457 run data modify storage ui:gun temp set value {Name:'{"text":"トリプルトルネード","color":"gold"}',TimeUse:59,ShotType:1,ShotCT:1,BurstCT:1,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:10,SpeedPlus:0,RangeType:1,Range:10,FlyParticle:102,EndParticle:104,Damage:0,MultiShot:1,ShotFootStep:0,Sound:2}
execute if score $subtype ui_temp matches 458 run data modify storage ui:gun temp set value {Name:'{"text":"ウルトラショット","color":"gold"}',TimeUse:54,ShotType:1,ShotCT:5,BurstCT:10,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:10,SpeedPlus:0,RangeType:1,Range:10,FlyParticle:102,EndParticle:105,Damage:0,MultiShot:1,ShotFootStep:1,Sound:5}
execute if score $subtype ui_temp matches 459 run data modify storage ui:gun temp set value {Name:'{"text":"ロケッティア","color":"gold"}',TimeUse:13,ShotType:1,ShotCT:1,BurstCT:5,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:10,SpeedPlus:0,RangeType:1,Range:10,FlyParticle:102,EndParticle:106,Damage:0,MultiShot:1,ShotFootStep:0,Sound:3}
