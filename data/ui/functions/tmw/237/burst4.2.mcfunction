# バースト回数記録
    execute store result score $burst4.id ui_temp run data get storage ui:gun temp.Burst
    execute store result score $burst4 ui_temp run scoreboard players get @s ui_use2
