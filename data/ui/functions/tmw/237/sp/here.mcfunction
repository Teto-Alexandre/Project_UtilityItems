...
# スーパースター
    ...
    execute if score $sptype ui_temp matches 252 run effect give @s strength 6 4 false
...
# レーダー
    ...
    execute if score $sptype ui_temp matches 255 as @a unless score $team ui_temp = @s ui_team run effect give @s glowing 3 0 false
...
# トーテム
    ...
    execute if score $sptype ui_temp matches 257 run item replace entity @a[tag=ui_temp_team] weapon.offhand with totem_of_undying
