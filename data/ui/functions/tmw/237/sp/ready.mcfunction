...
execute if score $sptype ui_temp matches 258 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"リゲイン","color":"gold"},{"text":"]","color":"gray"},{"text":"のチャージを完了しました！","color":"white"}]
...
execute if score $sptype ui_temp matches 456 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"バウンシーボム","color":"gold"},{"text":"]","color":"gray"},{"text":"のチャージを完了しました！","color":"white"}]
execute if score $sptype ui_temp matches 457 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"トリプルトルネード","color":"gold"},{"text":"]","color":"gray"},{"text":"のチャージを完了しました！","color":"white"}]
execute if score $sptype ui_temp matches 458 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"ウルトラショット","color":"gold"},{"text":"]","color":"gray"},{"text":"のチャージを完了しました！","color":"white"}]
execute if score $sptype ui_temp matches 459 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"ロケッティア","color":"gold"},{"text":"]","color":"gray"},{"text":"のチャージを完了しました！","color":"white"}]
execute if score $sptype ui_temp matches 460 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"ナイスダマ","color":"gold"},{"text":"]","color":"gray"},{"text":"のチャージを完了しました！","color":"white"}]
