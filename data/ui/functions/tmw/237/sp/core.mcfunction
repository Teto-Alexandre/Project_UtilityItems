...
execute if score $sptype ui_temp matches 401..500 run function ui:tmw/237/sp/static
...
execute if score $sptype ui_temp matches 202 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"アメフラシ","color":"gold"},{"text":"]","color":"gray"},{"text":"を発動しました！","color":"white"}]
...
execute if score $sptype ui_temp matches 401 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"メガホンレーザー","color":"gold"},{"text":"]","color":"gray"},{"text":"を発動しました！","color":"white"}]
