...
execute if score $time ui_temp matches 0 anchored eyes positioned ^ ^ ^ run function ui:tmw/237/sp/time/452.0
execute if score $time ui_temp matches 1 anchored eyes positioned ^ ^ ^ run function ui:tmw/237/sp/time/452.1
