#見た目
    ...
    execute if score $team ui_temp matches 1 store result score $paint ui_temp run fill ~ ~ ~ ~ ~-4 ~ light_blue_wool replace #ui:wools
    ...
    execute if score $team ui_temp matches 2 store result score $paint ui_temp run fill ~ ~ ~ ~ ~-4 ~ pink_wool replace #ui:wools
