...
#重力補正
execute if score @s ui_bpart matches 4..39 if score $temp ui_bcp matches 1.. at @s run function ui:tmw/237/projectile/gravity
...
execute as @s[scores={ui_br=..0}] run scoreboard players set @s ui_bcp 5
execute as @s[scores={ui_br=..0}] at @s run teleport @s ~ ~ ~ ~ 90
