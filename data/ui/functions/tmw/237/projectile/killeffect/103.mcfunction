...
execute as @e[distance=1..50,tag=!ui_temp_team,predicate=ui:load_unhurtable] unless score @s ui_obj_id matches -2147483648..2147483647 run function ui:misc/act/make_obj_id
tag @e[distance=1..50,tag=!ui_temp_team,predicate=ui:load_unhurtable,sort=nearest,limit=1] add ui_temp_target
