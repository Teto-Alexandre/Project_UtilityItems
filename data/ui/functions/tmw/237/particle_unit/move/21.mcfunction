#見た目
    ...
    execute if score $team ui_temp matches 1 store result score $temp ui_temp run fill ~0.3 ~ ~0.3 ~-0.3 ~-7 ~-0.3 light_blue_wool replace #ui:wools
    ...
    execute if score $team ui_temp matches 2 store result score $temp ui_temp run fill ~0.3 ~ ~0.3 ~-0.3 ~-7 ~-0.3 pink_wool replace #ui:wools
