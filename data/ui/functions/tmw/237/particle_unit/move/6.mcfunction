#見た目
    ...
    execute if score $team ui_temp matches 1 store result score $temp ui_temp run fill ~ ~ ~ ~ ~-1 ~ light_blue_wool replace #ui:wools
    ...
    execute if score $team ui_temp matches 2 store result score $temp ui_temp run fill ~ ~ ~ ~ ~-1 ~ pink_wool replace #ui:wools
