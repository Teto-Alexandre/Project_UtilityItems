...
# 常時実行
    ...
    execute if score @s ui_is2 matches 1.. run playsound entity.ghast.hurt ambient @a ^ ^ ^5 1 0.8 0
    ...
    execute if score @s ui_is2 matches 120.. run tag @s add ui_237_sub_explode
