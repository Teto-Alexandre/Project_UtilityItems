...
# 出現からの時間に応じて同じidのビットを追加
    #外側
    execute if score @s ui_uses matches 10 run summon armor_stand ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_201_1","tmw_237_sub_201_2","ui_temp_obj"],Invisible:1b,NoGravity:1b,Marker:1b}
    execute if score @s ui_uses matches 10 run summon armor_stand ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_201_1","tmw_237_sub_201_1_1","tmw_237_sub_201_2_1","ui_temp_obj"],Invisible:1b,NoGravity:1b,Marker:1b}
    execute if score @s ui_uses matches 10 run summon armor_stand ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_201_1","tmw_237_sub_201_1_1","tmw_237_sub_201_2_2","ui_temp_obj"],Invisible:1b,NoGravity:1b,Marker:1b}
    #内側
    execute if score @s ui_uses matches 40 run summon armor_stand ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_201_1","tmw_237_sub_201_3","ui_temp_obj"],Invisible:1b,NoGravity:1b,Marker:1b}
    execute if score @s ui_uses matches 40 run summon armor_stand ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_201_1","tmw_237_sub_201_1_1","tmw_237_sub_201_3_1","ui_temp_obj"],Invisible:1b,NoGravity:1b,Marker:1b}
    execute if score @s ui_uses matches 40 run summon armor_stand ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_201_1","tmw_237_sub_201_1_1","tmw_237_sub_201_3_2","ui_temp_obj"],Invisible:1b,NoGravity:1b,Marker:1b}
    #idコピー
...
# ビットを配列
    execute at @s as @e[tag=ui_temp_obj,tag=tmw_237_sub_201_2] rotated as @s run teleport @s ~ ~ ~ ~ ~
    execute at @s as @e[tag=ui_temp_obj,tag=tmw_237_sub_201_3] rotated as @s run teleport @s ~ ~ ~ ~ ~
    execute as @e[tag=ui_temp_obj,tag=tmw_237_sub_201_2] at @s run teleport @s ~ ~ ~ ~17 ~
    execute as @e[tag=ui_temp_obj,tag=tmw_237_sub_201_3] at @s run teleport @s ~ ~ ~ ~7 ~
    execute at @e[tag=ui_temp_obj,tag=tmw_237_sub_201_2] run teleport @e[tag=ui_temp_obj,tag=tmw_237_sub_201_2_1] ^ ^ ^-0.5 ~ ~
    execute at @e[tag=ui_temp_obj,tag=tmw_237_sub_201_2] run teleport @e[tag=ui_temp_obj,tag=tmw_237_sub_201_2_2] ^ ^ ^0.5 ~-180 ~
    execute at @e[tag=ui_temp_obj,tag=tmw_237_sub_201_3] run teleport @e[tag=ui_temp_obj,tag=tmw_237_sub_201_3_1] ^ ^ ^-3 ~ ~
    execute at @e[tag=ui_temp_obj,tag=tmw_237_sub_201_3] run teleport @e[tag=ui_temp_obj,tag=tmw_237_sub_201_3_2] ^ ^ ^3 ~-180 ~
    scoreboard players operation $temp ui_temp = @s ui_uses
    execute as @e[tag=ui_temp_obj,tag=tmw_237_sub_201_1_1] run function ui:tmw/237/sub/explosive/201/tick.rotator

# 弾
    execute if score @s ui_uses matches 10..100 as @e[tag=ui_temp_obj,tag=tmw_237_sub_201_1_1] at @s run function ui:tmw/237/sub/explosive/201/tick.line

# メイン
    execute if score @s ui_team matches 1 run function ui:tmw/237/sub/explosive/201/1
    execute if score @s ui_team matches 2 run function ui:tmw/237/sub/explosive/201/2
    execute if score @s ui_team matches 3 run function ui:tmw/237/sub/explosive/201/3
    execute if score @s ui_team matches 4 run function ui:tmw/237/sub/explosive/201/4
...
# 当たり判定
    execute if score $temp2 ui_temp matches 0 if score @s ui_uses matches 10..19 at @e[distance=..2,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:tmw/237/sub/explosive/201/hit
    execute if score $temp2 ui_temp matches 0 if score @s ui_uses matches 20..29 at @e[distance=..3,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:tmw/237/sub/explosive/201/hit
    execute if score $temp2 ui_temp matches 0 if score @s ui_uses matches 30..39 at @e[distance=..4,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:tmw/237/sub/explosive/201/hit
    execute if score $temp2 ui_temp matches 0 if score @s ui_uses matches 40..49 at @e[distance=..5,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:tmw/237/sub/explosive/201/hit
    execute if score $temp2 ui_temp matches 0 if score @s ui_uses matches 50..59 at @e[distance=..6,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:tmw/237/sub/explosive/201/hit
