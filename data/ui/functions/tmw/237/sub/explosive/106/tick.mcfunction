...
# 常時実行
    ...
    execute if score @s ui_uses matches 20.. as @e[type=!#ui:notmob,distance=..6] if score @s ui_team = $temp ui_temp run effect give @s[nbt=!{active_effects:[{id:"minecraft:health_boost"}]}] health_boost 5 1 true
