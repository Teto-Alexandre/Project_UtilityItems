...
# 常時実行
    ...
    execute if score $temp2 ui_temp matches 0 positioned ~-0.5 ~ ~-0.5 if entity @e[dx=0,dy=3,dz=0,tag=!ui_temp_team,predicate=ui:load_unhurtable] run function ui:tmw/237/projectile/hit.marker
