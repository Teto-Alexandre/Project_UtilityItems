...
# 常時実行
    ...
    execute if score @s ui_uses matches 20 run scoreboard players set @s ui_is 500
...
# 処理終了
    ...
    execute as @s[tag=ui_237_sub_stop,tag=!ui_237_sub_first] run summon iron_golem ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub_110_1","tmw_237_sub_mult","ui_temp_obj","tds_nolog"],NoAI:1b,ActiveEffects:[{Id:14b,Amplifier:0,Duration:20000,ShowParticles:false}],DeathLootTable:"none",Attributes:[{Name:"generic.max_health",Base:1000}],Health:1000f,Silent:1}
    ...
    execute if score $count ui_temp matches 4.. run function ui:tmw/237/sub/explosive/mult
