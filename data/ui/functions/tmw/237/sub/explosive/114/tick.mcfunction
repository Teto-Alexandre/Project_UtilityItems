...
# 常時実行
    ...
    execute if score @s ui_uses matches 26 run playsound minecraft:block.note_block.harp player @a ~ ~ ~ 1 1.8 0
    execute if score @s ui_uses matches 28 run playsound minecraft:block.note_block.harp player @a ~ ~ ~ 1 1.9 0
    execute if score @s ui_uses matches 30 run playsound minecraft:block.note_block.harp player @a ~ ~ ~ 1 2.0 0
