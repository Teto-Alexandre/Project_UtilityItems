...
# 投擲物パーティクル
    ...
    execute if score $color ui_temp matches 1 store result score $temp ui_temp run fill ~ ~ ~ ~ ~-3 ~ light_blue_wool replace #ui:wools
    ...
    execute if score $color ui_temp matches 2 store result score $temp ui_temp run fill ~ ~ ~ ~ ~-3 ~ pink_wool replace #ui:wools
    execute if score $color ui_temp matches 3 run particle dust 1 1 0.5 1 ~ ~0.3 ~ 0.2 0.2 0.2 0 1 force
    execute if score $color ui_temp matches 3 run particle block yellow_concrete ~ ~0.3 ~ 0.2 0.2 0.2 0 1 force
    execute if score $color ui_temp matches 3 store result score $temp ui_temp run fill ~ ~ ~ ~ ~-3 ~ yellow_wool replace #ui:wools
    execute if score $color ui_temp matches 4 run particle dust 0.5 1 0.5 1 ~ ~0.3 ~ 0.2 0.2 0.2 0 1 force
    execute if score $color ui_temp matches 4 run particle block lime_concrete ~ ~0.3 ~ 0.2 0.2 0.2 0 1 force
    execute if score $color ui_temp matches 4 store result score $temp ui_temp run fill ~ ~ ~ ~ ~-3 ~ lime_wool replace #ui:wools
