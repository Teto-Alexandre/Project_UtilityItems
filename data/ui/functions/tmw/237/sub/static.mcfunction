summon item ~ ~ ~ {Tags:["ui_temp_this","tmw_237_sub","ui_refd"],Invulnerable:1b,Item:{id:"minecraft:snowball",Count:1b,tag:{tmw:{type:1,color:1},CustomModelData:217111}},PickupDelay:32767s}
