...
# エフェクト
    execute if score $color ui_temp matches 1 run particle block light_blue_concrete ~ ~1.2 ~ 0.1 0.1 0.1 0 2 normal
    execute if score $color ui_temp matches 2 run particle block pink_concrete ~ ~1.2 ~ 0.1 0.1 0.1 0 2 normal
