...
# コンバットからスキャン
execute if score $mode ui_temp matches 1 run scoreboard players set @s ui_tmw501_19_mct 25
...
# スキャンからコンバット
execute if score $mode ui_temp matches 2 run scoreboard players set @s ui_tmw501_19_mct 25
