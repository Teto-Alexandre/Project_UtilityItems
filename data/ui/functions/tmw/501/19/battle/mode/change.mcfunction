...
#
execute as @s[tag=tmw_501_19_scan_ilv] run scoreboard players remove @s ui_tmw501_19_stat_ilv 2
...
execute if score @s ui_tmw501_19_mct matches 2 if score @s ui_tmw501_19_now_hud matches 1 run tellraw @s {"text":"カメラON"}
execute if score @s ui_tmw501_19_mct matches 2 if score @s ui_tmw501_19_now_hud matches 1 run function ui:tmw/501/19/battle/camera/change/trigger
