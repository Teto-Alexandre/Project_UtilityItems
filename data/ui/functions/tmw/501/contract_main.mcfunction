...
# 契約
    ...
    execute if entity @s[scores={ui_tmw_con_id=12}] run function ui:tmw/501/contract/12
    execute if entity @s[scores={ui_tmw_con_id=13}] run function ui:tmw/501/contract/13
    execute if entity @s[scores={ui_tmw_con_id=14}] run function ui:tmw/501/contract/14
