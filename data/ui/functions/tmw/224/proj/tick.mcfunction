...
#ダメージ
    ...
    #ダメージ判定
        execute if entity @s[tag=!ui_224_nohit] positioned ~-0.5 ~0.1 ~-0.5 positioned ~0.3 ~0.0 ~0.3 if entity @e[dx=0,predicate=ui:load_unhurtable] at @s positioned ~-0.5 ~-0.4 ~-0.5 positioned ~-0.3 ~-0.3 ~-0.3 if entity @e[dx=0,predicate=ui:load_unhurtable] at @s run function ui:tmw/224/proj/hit
