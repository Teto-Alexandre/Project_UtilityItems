...
# tnt
execute if score $feet ui_temp matches 1006 run function ui:tmw/601/feet/6/main
# 跳躍
execute if score $feet ui_temp matches 1007 run function ui:tmw/601/feet/7/main
