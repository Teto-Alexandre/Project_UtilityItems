...
scoreboard players set $tmw.success ui_temp 0
...
#誰かがid:255持ったら各自に実行する
    ...
    execute if score $tmw.type ui_temp matches 1 if score $hold_item_type ui_temp matches 0 if score $noidle ui_temp matches 1 if score $tmw.success ui_temp matches 0 run function ui:tmw/255/player/crossbow/main
    execute if score $tmw.type ui_temp matches 1 if score $hold_item_type ui_temp matches 1 if score $noidle ui_temp matches 1 if score $tmw.success ui_temp matches 0 run function ui:tmw/255/player/carrot_on_the_stick/main
