...
# 弾を出す
    ...
    execute if score $spread ui_temp matches 1.. run function ui:tmw/255/player/crossbow/attack/shot/spreadmanager/square_shuffle
    execute facing entity @e[tag=ui_marker,limit=1] feet run function ui:tmw/255/player/crossbow/attack/shot/fire_straight
