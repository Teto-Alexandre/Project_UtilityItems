...
# LMG - IRONGOLEM_HIT-1-2-0,SKELETON_HURT-1-2-0,ZOMBIE_WOOD-1-2-0,ITEM_BREAK-1-2-2,NOTE_SNARE_DRUM-1-0-2,BLAZE_HIT-1-2-0,DOOR_CLOSE-1-2-4
    execute if score $sound ui_temp matches -3 run function ui:tmw/255/player/crossbow/attack/shot/sound/downer/3
# PDW - SHOOT_ARROW-1-2-0,NOTE_SNARE_DRUM-1-0-2,SKELETON_HURT-1-2-0,ZOMBIE_WOOD-1-2-0
    execute if score $sound ui_temp matches -4 run function ui:tmw/255/player/crossbow/attack/shot/sound/downer/4
# SG - WITHER_SHOOT-1-2-0,EXPLODE-1-2-0
    execute if score $sound ui_temp matches -5 run function ui:tmw/255/player/crossbow/attack/shot/sound/downer/5
# HG - BLAZE_HIT-1-2-0,ZOMBIE_WOOD-1-2-0,DOOR_CLOSE-1-2-4
    execute if score $sound ui_temp matches -6 run function ui:tmw/255/player/crossbow/attack/shot/sound/downer/6
# SR - IRONGOLEM_HIT-1-2-0,SKELETON_HURT-1-2-0,ZOMBIE_WOOD-1-2-0,FIRE_IGNITE-1-1-4,DOOR_OPEN-1-2-6
    execute if score $sound ui_temp matches -7 run function ui:tmw/255/player/crossbow/attack/shot/sound/downer/7
# DustShot
