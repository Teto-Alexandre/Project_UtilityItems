...
execute if score $muzzle ui_temp matches 3 anchored eyes run particle crit ^-0.25 ^-0.1 ^0.7 0 0 0 0.3 20
execute if score $muzzle ui_temp matches 3 anchored eyes run particle explosion ^-0.25 ^-0.1 ^0.7 0 0 0 0 1
