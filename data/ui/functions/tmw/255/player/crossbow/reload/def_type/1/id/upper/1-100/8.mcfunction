...
scoreboard players operation $success.section ui_temp += $success.temp ui_temp
execute store success score $success.temp ui_temp run clear @s glowstone_dust 0
scoreboard players operation $success.section ui_temp += $success.temp ui_temp
...
execute if score $success.section ui_temp matches 3.. run clear @s glowstone_dust 1
