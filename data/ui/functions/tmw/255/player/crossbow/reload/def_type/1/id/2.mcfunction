...
scoreboard players operation $success.section ui_temp += $success.temp ui_temp
execute if score $success.section ui_temp matches 2.. run clear @s gold_nugget 1
execute if score $success.section ui_temp matches 2.. run clear @s gunpowder 2
