#> ui:tmw/255/player/crossbow/ss/eo/tec
#
# #負荷軽減用に Team が一致するパーティクルを一元管理する
#
# @within function ui:tmw/255/player/crossbow/ss/eo/s_team_id
...
# 再帰
execute if entity @e[tag=ui_tec] as @e[limit=1,tag=ui_tec] run function ui:tmw/255/player/crossbow/ss/eo/tec
