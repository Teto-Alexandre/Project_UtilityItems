#> ui:tmw/255/player/crossbow/ss/eo/idc
#
# #負荷軽減用に ID が一致するパーティクルを一元管理する
#
# @within function ui:tmw/255/player/crossbow/ss/eo/tec
...
execute as @e[tag=ui_temp_id_control] at @s run function ui:tmw/255/projectile/tick
