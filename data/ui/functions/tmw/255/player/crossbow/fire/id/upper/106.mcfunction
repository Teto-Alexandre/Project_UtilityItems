...
#
    ...
    execute if score $firetime.temp ui_temp matches 0..9 at @s run particle dust 0.2 0.1 0 1.1 ~ ~ ~ 1 0.1 1 0 20 force
    execute if score $firetime.temp ui_temp matches 10..19 at @s run particle dust 0.4 0.2 0 1.1 ~ ~ ~ 1 0.1 1 0 20 force
    execute if score $firetime.temp ui_temp matches 20..29 at @s run particle dust 0.6 0.3 0 1.1 ~ ~ ~ 1 0.1 1 0 20 force
    execute if score $firetime.temp ui_temp matches 30..39 at @s run particle dust 0.8 0.4 0 1.1 ~ ~ ~ 1 0.1 1 0 20 force
    execute if score $firetime.temp ui_temp matches 40..49 at @s run particle dust 1.0 0.5 0 1.1 ~ ~ ~ 1 0.1 1 0 20 force
    execute if score $firetime.temp ui_temp matches 25.. at @s run particle flame ~ ~ ~ 1 0.1 1 0 10 force
    ...
    execute if score $firetime.temp ui_temp matches 50 at @s run particle dust 1 0.2 0.2 0.5 ~ ~ ~ 1.5 0.1 1.5 0 50 force
    execute if score $firetime.temp ui_temp matches 50 at @s run particle small_flame ~ ~ ~ 1 0.1 1 0.1 100 force
