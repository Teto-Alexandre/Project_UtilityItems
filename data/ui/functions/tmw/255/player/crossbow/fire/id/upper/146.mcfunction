...
#
    ...
    execute if score $firetime.temp ui_temp matches 10 run data merge storage ui:common {input:{Mode:"create",Var:-10034,Var2:2}}
    execute if score $firetime.temp ui_temp matches 10 at @s anchored feet rotated ~ 0 positioned ^ ^ ^1 rotated ~-90 90 run function ui:common/particle
