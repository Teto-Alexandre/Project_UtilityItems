...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 run item replace entity @s[nbt=!{Inventory:[{Slot:-106b}]}] weapon.offhand with carrot_on_a_stick{CustomModelData:180089,Null:1,Damage:25,display:{Name:'{"text":"デュランダル・抜剣"}'}}
