...
#
    execute if entity @s[tag=tmw_active_temp] if score $firetime.temp ui_temp matches 8..100 in overworld store result score $firetime ui_temp run time query gametime
    ...
    execute if entity @s[tag=tmw_active_temp] if score $firetime.temp ui_temp matches 108..200 in overworld store result score $firetime ui_temp run time query gametime
    ...
    execute if entity @s[tag=tmw_active_temp] if score $firetime.temp ui_temp matches 200..205 in overworld store result score $firetime ui_temp run time query gametime
...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 run execute in overworld store result score $cooltime ui_temp run time query gametime
...
#
    ...
    execute if score $firetime.temp ui_temp matches 100 run execute in overworld store result score $cooltime ui_temp run time query gametime
    ...
    execute if score $firetime.temp ui_temp matches 102 run execute in overworld store result score $cooltime ui_temp run time query gametime
...
#
    ...
    execute if score $firetime.temp ui_temp matches 200 run execute in overworld store result score $cooltime ui_temp run time query gametime
    ...
    execute if score $firetime.temp ui_temp matches 202 run execute in overworld store result score $cooltime ui_temp run time query gametime
    ...
    execute if score $firetime.temp ui_temp matches 204 run execute in overworld store result score $cooltime ui_temp run time query gametime
    ...
    execute if score $firetime.temp ui_temp matches 206 run execute in overworld store result score $cooltime ui_temp run time query gametime
...
#
    ...
    execute if score $firetime.temp ui_temp matches 226 run execute in overworld store result score $cooltime ui_temp run time query gametime
