...
#
    ...
    execute if score $firetime.temp ui_temp matches 2 run data merge storage ui:common {input:{Mode:"create",Var:-10031}}
    execute if score $firetime.temp ui_temp matches 2 at @s anchored eyes positioned ^ ^ ^3 run function ui:common/particle
