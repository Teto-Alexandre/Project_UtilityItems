...
# 耐久度ダメージ
    ...
    execute at @e[tag=ui_temp_this] run particle dust 1 1 0 0.8 ~ ~ ~ 0.3 0.5 0.3 0 5 force
    execute at @e[tag=ui_temp_this] run particle block sand ~ ~0.5 ~ 0.3 0.5 0.3 0 3 force
