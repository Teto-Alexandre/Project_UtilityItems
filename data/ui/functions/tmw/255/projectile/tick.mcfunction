...
execute unless score @s ui_bm > #1 ui_num at @s run function ui:tmw/255/projectile/end
execute unless score @s ui_br matches -2147483648..2147483647 if score @s ui_bm <= @s ui_bm_lim at @s run function ui:tmw/255/projectile/end
