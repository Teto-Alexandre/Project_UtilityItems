...
execute at @s positioned ^ ^ ^1.5 rotated ~90 ~-90 run function ui:common/particle
...
data merge storage ui:common {input:{Mode:"create",Var:28,Var2:3}}
execute at @s positioned ^ ^ ^2.5 rotated ~90 ~-90 run function ui:common/particle

#
execute as @e[tag=ui_temp_target,limit=1] at @s anchored eyes positioned ^ ^ ^10 run teleport @e[tag=ui_temp_this] ~ ~ ~ facing entity @e[tag=ui_temp_target,limit=1] eyes
