# 命中処理
    ...
    execute if score @s ui_bt matches 1.. as @e[tag=!ui_temp_team,type=!#ui:unhurtable,tag=!ui_unhurtable,sort=nearest,limit=1] at @s run function ui:tmw/305/proj/hit1
