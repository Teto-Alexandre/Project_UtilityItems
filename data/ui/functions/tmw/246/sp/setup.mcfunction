...
#コアの当たり判定を設定
execute at @s align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:iron_golem ~ ~2.5 ~ {Tags:["ui","ui_hitbox","ui_h_c","tds_nolog"],Silent:1b,NoAI:1b,NoGravity:1b,ActiveEffects:[{Id:14,Duration:20000,Amplifier:1b,ShowParticles:0b}],Attributes:[{Name:"generic.max_health",Base:1000}],Health:1000.0f,DeathLootTable:"ui:empty"}
