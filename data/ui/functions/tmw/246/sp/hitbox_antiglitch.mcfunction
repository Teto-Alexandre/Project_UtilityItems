...
execute at @s[tag=ui_d_core] unless entity @e[tag=ui_hitbox,distance=..3] align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:iron_golem ~ ~-1.5 ~ {Tags:["ui","ui_hitbox2","ui_h_c","tds_nolog"],Silent:1b,NoAI:1b,NoGravity:1b,active_effects:[{id:"minecraft:invisibility",duration:20000,amplifier:1b,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:1000}],Health:1000.0f,DeathLootTable:"ui:empty"}
...
execute at @s[tag=!ui_d_core] unless entity @e[tag=ui_hitbox,distance=..3] align xyz positioned ~0.5 ~0.5 ~0.5 run summon minecraft:iron_golem ~ ~-1.5 ~ {Tags:["ui","ui_hitbox2","ui_h_n","tds_nolog"],Silent:1b,NoAI:1b,NoGravity:1b,active_effects:[{id:"minecraft:invisibility",duration:20000,amplifier:1b,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:1000}],Health:1000.0f,DeathLootTable:"ui:empty"}
