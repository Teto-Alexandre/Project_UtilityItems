...
summon arrow 0 99 0 {Motion:[0.0d,10.0d,0.0d],Tags:["New"]}
...
summon skeleton 0 100 0 {DeathTime:19s,PersistenceRequired:1b,Tags:["2"],DeathLootTable:"ui:empty"}
summon arrow 0 99 0 {Motion:[0.0d,10.0d,0.0d],Tags:["New"]}

execute as @e[tag=New] run data modify entity @s Owner set from entity @a[limit=1] UUID
