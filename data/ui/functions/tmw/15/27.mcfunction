...
scoreboard players set $c.proj.range ui_temp 160
scoreboard players set $c.proj.particle ui_temp 15
scoreboard players set $c.proj.autohit ui_temp 1
scoreboard players set $c.proj.particle2 ui_temp 16
...
execute store result score $temp ui_temp run fill ~-0.5 ~-0.5 ~-0.5 ~0.5 ~0.5 ~0.5 pink_wool replace #ui:wools
