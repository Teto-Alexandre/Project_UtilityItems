...
# データ読み取り
    ...
    execute unless score $luck ui_temp matches 0 if score $hide ui_temp matches 0 if score @s ui_d_luck matches 1.. run tellraw @s [{"text":"※ダイス干渉※ ","color":"dark_green"},{"selector":"@s"},{"text":"の次のダイスは","color":"gray"},{"text":"幸運","color":"aqua"},{"text":"になる","color":"gray"}]
    execute unless score $luck ui_temp matches 0 if score $hide ui_temp matches 0 if score @s ui_d_luck matches ..-1 run tellraw @s [{"text":"※ダイス干渉※ ","color":"dark_green"},{"selector":"@s"},{"text":"の次のダイスは","color":"gray"},{"text":"不運","color":"red"},{"text":"になる","color":"gray"}]
    ...
    execute unless score $num ui_temp matches 0 if score $hide ui_temp matches 0 if score @s ui_d_addnum matches 1.. run tellraw @s [{"text":"※ダイス干渉※ ","color":"dark_green"},{"selector":"@s"},{"text":"の次のダイスは","color":"gray"},{"score":{"name": "@s","objective": "ui_d_addnum"},"color":"aqua"},{"text":"される","color":"gray"}]
    execute unless score $num ui_temp matches 0 if score $hide ui_temp matches 0 if score @s ui_d_addnum matches 0 run tellraw @s [{"text":"※ダイス干渉※ ","color":"dark_green"},{"selector":"@s"},{"text":"の次のダイスは","color":"gray"},{"text":"±0","color":"white"},{"text":"される","color":"gray"}]
    execute unless score $num ui_temp matches 0 if score $hide ui_temp matches 0 if score @s ui_d_addnum matches ..-1 run tellraw @s [{"text":"※ダイス干渉※ ","color":"dark_green"},{"selector":"@s"},{"text":"の次のダイスは","color":"gray"},{"score":{"name": "@s","objective": "ui_d_addnum"},"color":"red"},{"text":"される","color":"gray"}]
    execute unless score $num ui_temp matches 0 if score @s ui_d_addnum matches 1.. run tellraw @s [{"text":"※ダイス干渉※ ","color":"dark_green"},{"text":"あなたの次のダイスは","color":"gray"},{"score":{"name": "@s","objective": "ui_d_addnum"},"color":"aqua"},{"text":"される","color":"gray"}]
    ...
    execute unless score $luck ui_temp matches 0 at @s run particle dust 1 0 1 4 ~ ~ ~ 0.5 0.5 0.5 0 15 force
    execute unless score $num ui_temp matches 0 at @s run particle dust 0 0.7 0 4 ~ ~ ~ 0.5 0.5 0.5 0 15 force
    execute at @s run playsound entity.shulker.ambient neutral @a ~ ~ ~ 1 0.7 0
    execute at @s run playsound entity.shulker.ambient neutral @a ~ ~ ~ 1 0.5 0
    execute at @s run playsound item.honey_bottle.drink neutral @a ~ ~ ~ 1 0.8 0
