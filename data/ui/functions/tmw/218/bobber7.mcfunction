...
execute at @s[scores={ui_is=119}] run loot spawn ~ ~ ~ kill @e[predicate=ui:load_unhurtable,sort=nearest,limit=1]
execute at @s[scores={ui_is=119}] run kill @e[predicate=ui:load_unhurtable,sort=nearest,limit=1]
