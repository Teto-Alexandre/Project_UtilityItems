...
execute if data storage ui:temp temp.effect{effect_mode:"msg"} run tellraw @a[tag=ui_temp_players] ["",{"selector":"@s"},{"text":"の","color":"gray"},{"score":{"name": "$condition_checker_temp","objective": "ui_temp"}},{"text":"つの持続効果に干渉した！"}]
