...
execute unless score $repeat ui_temp matches -1..0 store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.DeathEffects[0].repeat int 1 run scoreboard players remove $repeat ui_temp 1
