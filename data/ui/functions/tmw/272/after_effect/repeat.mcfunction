...
execute unless score $repeat ui_temp matches 0 store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.AfterEffects[0].repeat int 1 run scoreboard players remove $repeat ui_temp 1
