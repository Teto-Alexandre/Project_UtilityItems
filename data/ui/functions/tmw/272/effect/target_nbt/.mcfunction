...
execute if data storage ui:temp temp.effect.target_nbt.ifdata run function ui:tmw/272/effect/target_nbt/ifdata with storage ui:temp temp.effect.ifdata
