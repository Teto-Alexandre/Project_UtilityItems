...
execute unless data storage ui:temp temp.effect.target_entity.invert run tag @e[tag=ui_temp_players,tag=!tmw272_temp_card_effect_target_entity] add ui_temp_players_no_target
execute if data storage ui:temp temp.effect.target_entity.invert run tag @e[tag=ui_temp_players,tag=tmw272_temp_card_effect_target_entity] add ui_temp_players_no_target
