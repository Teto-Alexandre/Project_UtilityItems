...
execute if score $effect_type ui_temp matches 1 run function ui:tmw/272/effect/effect_type/1
execute if score $effect_type ui_temp matches 2 run function ui:tmw/272/effect/effect_type/2
execute if score $effect_type ui_temp matches 3 run function ui:tmw/272/effect/effect_type/3
execute if score $effect_type ui_temp matches 4 run function ui:tmw/272/effect/effect_type/4
execute if score $effect_type ui_temp matches 5 run function ui:tmw/272/effect/effect_type/5
execute if score $effect_type ui_temp matches 6 run function ui:tmw/272/effect/effect_type/6
