...
# ここで回避済みならターゲットから消える
execute if entity @e[tag=tmw272_temp_card_effect_protection] unless data storage ui:temp temp.effect.indep unless data storage ui:temp temp.effect.no_protection unless data storage ui:temp temp.effect{effect_type:"damage"} as @e[tag=tmw272_temp_card_effect_target] as @s[tag=tmw272_temp_card_effect_protection] run function ui:tmw/272/effect/misc/protection/target_fix
execute if entity @e[tag=tmw272_temp_card_effect_dodge] unless data storage ui:temp temp.effect.indep unless data storage ui:temp temp.effect.no_dodge as @e[tag=tmw272_temp_card_effect_target] run tag @s[tag=tmw272_temp_card_effect_dodge] remove tmw272_temp_card_effect_target
...
execute unless data storage ui:temp temp.effect.no_target_old run tag @e[tag=tmw272_temp_card_effect_target] add tmw272_temp_card_effect_target_old
