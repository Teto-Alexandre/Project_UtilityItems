...
execute if score $duplication ui_temp matches 1.. run function ui:tmw/272/effect/misc/duplication/
...
execute if score $particle_other ui_temp matches 1.. positioned as @e[tag=ui_temp_players,tag=!ui_temp_player,tag=!tmw272_visual_input] run function ui:tmw/272/effect/particle_type/other
execute if score $particle_laser ui_temp matches 1.. positioned as @e[tag=ui_temp_players,tag=!ui_temp_player] run function ui:tmw/272/effect/particle_type/laser
