...
execute if entity @s[tag=tmw272_temp_card_effect_activated_protection] if score @s ui_tmw272_silence matches 1.. run function ui:tmw/272/effect/misc/protection/end_of_effect
