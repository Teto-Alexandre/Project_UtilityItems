...
execute if data storage ui:temp temp.effect.rand.min_condition unless data storage ui:temp temp.effect.rand.keep_condition run scoreboard players set $condition_checker ui_temp 0
execute if data storage ui:temp temp.effect.rand.max_condition unless data storage ui:temp temp.effect.rand.keep_condition run scoreboard players set $condition_checker ui_temp 0
