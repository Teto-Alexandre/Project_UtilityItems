...
execute if score $count_temp ui_temp matches 1.. run data modify storage ui:temp temp.card.effects append value {input:condition,effect_mode:set,var:0,no_intercept_command:1,no_reactive_effect:1,mute:1}
