...
execute unless data storage ui:temp temp.effect{effect_mode:"="} run scoreboard players operation @e[tag=tmw272_temp_card_effect_target] ui_tmw272_mana_max = $var ui_temp
