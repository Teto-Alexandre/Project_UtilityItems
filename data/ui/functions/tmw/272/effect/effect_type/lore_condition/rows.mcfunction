...
execute if score $name_condition_check ui_temp matches 1 unless score $name_condition_rows ui_temp matches 1.. if data storage ui:temp temp.effect.list2.fail run data modify storage ui:temp card.list2 append from storage ui:temp name_condition.list[0]
