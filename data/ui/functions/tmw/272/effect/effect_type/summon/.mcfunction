...
$execute if data storage ui:temp temp.effect.id run summon $(id) ~ ~ ~ {NoAI:1,Invulnerable:1b,CustomNameVisible:1b,Silent:1b,Tags:["hc_deck","summoned_nocount","hc_deck_temp"]}
