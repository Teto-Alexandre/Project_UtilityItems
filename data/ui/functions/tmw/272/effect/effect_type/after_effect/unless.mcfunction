...
execute unless data storage ui:temp temp.effect.cg.target_ids[0] as @e[tag=tmw272_temp_card_effect_target] run function ui:tmw/272/effect/effect_type/after_effect/append
