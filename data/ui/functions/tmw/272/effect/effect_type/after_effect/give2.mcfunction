...
execute unless data storage ui:temp temp.effect.cg.target_ids run data modify storage ui:temp temp.effect.cg.target_ids set value []
execute unless data storage ui:temp temp.effect.cg.target_ids[0] run data modify storage ui:temp temp.effect.cg.target_ids append from storage ui:temp temp.target_ids_temp
