...
execute if data storage ui:temp temp.effect.no_self run data modify storage ui:temp temp.effect.cg.reactive_effect.no_self set from storage ui:temp temp.effect.no_self
    execute if data storage ui:temp temp.effect.from_other run data modify storage ui:temp temp.effect.cg.reactive_effect.no_self set from storage ui:temp temp.effect.from_other
