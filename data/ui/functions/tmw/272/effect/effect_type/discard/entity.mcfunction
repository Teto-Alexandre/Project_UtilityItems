...
execute if score $hand_count ui_temp matches 1.. run scoreboard players add $condition_checker_temp ui_temp 1

execute if score $hand_count ui_temp matches ..-2 run data remove storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand[1]
execute if score $hand_count ui_temp matches ..-2 run scoreboard players add $condition_checker_temp ui_temp 1
