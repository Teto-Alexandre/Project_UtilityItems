# カードを捨てるテスト
execute if entity @s[type=player] run function ui:tmw/272/effect/effect_type/discard/player/macro with storage ui:temp temp.effect
...
execute if score $var_temp ui_temp matches 1.. run function ui:tmw/272/effect/effect_type/discard/3_macro
