...
execute if score $just_check ui_temp matches 0 if data storage ui:temp temp.effect.temp2.tag.tmw.cg.discard_effect run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.AfterEffects append from storage ui:temp temp.effect.temp2.tag.tmw.cg.discard_effect
