...
execute unless data storage ui:temp temp.effect.no_discard_effect if score $just_check ui_temp matches 0 if data storage ui:temp temp.effect.temp2.tag.tmw.cg.discard_effect run function ui:tmw/272/effect/effect_type/discard/discard_effect
