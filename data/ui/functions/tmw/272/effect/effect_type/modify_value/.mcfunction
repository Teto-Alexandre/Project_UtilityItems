execute unless data storage ui:temp temp.effect.no_hexproof as @e[tag=tmw272_temp_card_effect_target,tag=!ui_temp_player] if score @s ui_tmw272_hexproof matches 1.. run tag @s remove tmw272_temp_card_effect_target
