...
#execute if score $name_condition_check ui_temp matches 0 if score $name_condition_dup ui_temp matches 0 run tellraw @s [{"text":" > "},{"text":"一致1","color":"green"},{"text":" ← "},{"storage":"ui:temp","nbt":"name_condition.name","interpret":true},{"text":" = "},{"storage":"ui:temp","nbt":"name_condition.list[0].tag.display.Name","interpret":true}]
#execute if score $name_condition_check ui_temp matches 0 unless score $name_condition_dup ui_temp matches 0 run tellraw @s [{"text":" > "},{"text":"一致2","color":"green"},{"text":" ← "},{"storage":"ui:temp","nbt":"name_condition.name","interpret":true},{"text":" = "},{"storage":"ui:temp","nbt":"name_condition.list[0].tag.display.Name","interpret":true}]
...
execute if score $name_condition_count ui_temp matches 1.. run function ui:tmw/272/effect/effect_type/name_duplication/name
