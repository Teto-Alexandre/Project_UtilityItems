...
execute if score $effect_type_damage_info ui_temp matches 1 if score @s ui_tmw272_thorn matches 1.. run function ui:tmw/272/effect/effect_type/damage/thorn
...
execute if score $effect_type_damage_info ui_temp matches 3 if score @s ui_tmw272_thorn matches 1.. run function ui:tmw/272/effect/effect_type/damage/thorn
