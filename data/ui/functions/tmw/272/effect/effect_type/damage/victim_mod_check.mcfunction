# 眠気
execute unless data storage ui:temp temp.effect.no_drowsy if score @s ui_tmw272_drowsy matches 1.. run function ui:tmw/272/effect/effect_type/damage/drowsy
