...
execute if data storage ui:temp temp.effect{effect_mode:"set"} run scoreboard players operation @e[tag=tmw272_temp_card_effect_target] ui_tmw272_mana = $var ui_temp
