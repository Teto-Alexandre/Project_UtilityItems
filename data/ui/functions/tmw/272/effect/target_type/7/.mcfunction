...
execute if data storage ui:temp temp.effect.target_ids run data modify storage ui:temp temp.target_ids_temp set from storage ui:temp temp.effect.target_ids
