...
summon marker ~ ~2 ~ {Tags:["tmw272_deck_dropper_core","tmw272_temp_unpower"]}
execute as @e[tag=tmw272_temp_unpower] at @s run setblock ~ ~ ~ dropper[facing=down]{CustomName:'{"text":"Null"}',Items:[{Slot:0b,id:"minecraft:stone",Count:1b,tag:{ui:{ismenu:1}}},{Slot:1b,id:"minecraft:stone",Count:2b,tag:{ui:{ismenu:1}}},{Slot:2b,id:"minecraft:stone",Count:3b,tag:{ui:{ismenu:1}}},{Slot:3b,id:"minecraft:stone",Count:4b,tag:{ui:{ismenu:1}}},{Slot:4b,id:"minecraft:stone",Count:5b,tag:{ui:{ismenu:1}}},{Slot:5b,id:"minecraft:stone",Count:6b,tag:{ui:{ismenu:1}}},{Slot:6b,id:"minecraft:stone",Count:7b,tag:{ui:{ismenu:1}}},{Slot:7b,id:"minecraft:stone",Count:8b,tag:{ui:{ismenu:1}}},{Slot:8b,id:"minecraft:stone",Count:9b,tag:{ui:{ismenu:1}}}]}
