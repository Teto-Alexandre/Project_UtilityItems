...
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:9b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.9 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:10b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.10 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:11b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.11 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:12b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.12 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:13b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.13 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:14b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.14 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:15b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.15 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:16b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.16 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:17b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.17 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:18b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.18 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:19b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.19 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:20b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.20 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:21b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.21 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:22b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.22 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:23b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.23 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:24b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.24 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:25b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.25 with air
execute as @e[tag=tmw272_temp_unpower] at @s if block ~ ~ ~ dropper{Items:[{Slot:26b,tag:{ui:{ismenu:1}}}]} run item replace block ~ ~ ~ container.26 with air
