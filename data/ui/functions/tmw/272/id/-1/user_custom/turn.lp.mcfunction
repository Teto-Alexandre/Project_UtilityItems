...
execute if data storage cg_custom_temp: temp.ifdata{effect:"turn"} run function ui:tmw/272/id/-1/user_custom/macro/turn with storage cg_custom_temp: advanced_value[0]
