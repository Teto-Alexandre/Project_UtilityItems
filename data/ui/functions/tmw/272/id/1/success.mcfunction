...
# パーティクル
execute if score $particle_self ui_temp matches 1.. positioned as @s run function ui:tmw/272/id/1/particle_type/self
execute if score $particle_look ui_temp matches 1.. positioned as @e[tag=tmw272_visual_input] run function ui:tmw/272/id/1/particle_type/look
execute if score $particle_other ui_temp matches 1.. positioned as @e[tag=ui_temp_players,tag=!ui_temp_player,tag=!tmw272_visual_input] run function ui:tmw/272/id/1/particle_type/other
execute if score $particle_laser ui_temp matches 1.. positioned as @e[tag=ui_temp_players,tag=!ui_temp_player] run function ui:tmw/272/id/1/particle_type/laser
