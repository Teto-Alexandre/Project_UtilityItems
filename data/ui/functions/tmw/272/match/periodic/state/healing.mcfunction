...
execute if score @s ui_tmw272_healing matches -1 run scoreboard players set @s ui_tmw272_healing 0
scoreboard players operation @s ui_tmw272_healing /= #3 ui_num
