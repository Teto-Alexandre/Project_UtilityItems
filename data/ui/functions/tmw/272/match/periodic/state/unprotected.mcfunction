...
execute if score @s ui_tmw272_unprotected matches -1 run scoreboard players set @s ui_tmw272_unprotected 0
scoreboard players operation @s ui_tmw272_unprotected /= #3 ui_num
