...
execute if score @s ui_tmw272_powerful matches -1 run scoreboard players set @s ui_tmw272_powerful 0
scoreboard players operation @s ui_tmw272_powerful /= #3 ui_num
