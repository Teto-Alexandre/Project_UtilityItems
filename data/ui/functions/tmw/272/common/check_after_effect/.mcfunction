...
execute if score $delay_type ui_temp matches 1..2 unless data storage ui:temp card{ae_turn:-1} if score $check_after_effect ui_temp matches 1.. run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.AfterEffects[0].ae_turn set value 1
