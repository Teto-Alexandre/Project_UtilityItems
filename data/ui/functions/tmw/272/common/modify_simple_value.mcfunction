...
execute if data storage ui:tmw272 temp{input:"product"} if data storage ui:temp temp.effect{effect_mode:"set"} run scoreboard players operation @s ui_tmw272_product = $var ui_temp
execute if data storage ui:tmw272 temp{input:"fund"} if data storage ui:temp temp.effect{effect_mode:"set"} run scoreboard players operation @s ui_tmw272_fund = $var ui_temp
...
execute if data storage ui:tmw272 temp{input:"product"} unless data storage ui:temp temp.effect{effect_mode:"set"} run scoreboard players operation @s ui_tmw272_product += $var ui_temp
execute if data storage ui:tmw272 temp{input:"fund"} unless data storage ui:temp temp.effect{effect_mode:"set"} run scoreboard players operation @s ui_tmw272_fund += $var ui_temp
