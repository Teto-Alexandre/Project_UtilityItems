...
execute if data storage ui:temp card.cost{target:1} if score $cost_count ui_temp matches 1.. as @e[tag=tmw272_visual_input] run function ui:tmw/272/common/check_cost/cost_type/new/3/burn
execute unless data storage ui:temp card.cost{target:1} if score $cost_count ui_temp matches 1.. run function ui:tmw/272/common/check_cost/cost_type/new/3/burn
...
execute if score $cost ui_temp <= @s ui_tmw272_mana run tellraw @s[scores={ui_tmw601_accessory=5007}] ["",{"text":"> ","color":"gray","bold": true},{"text":"タイプ3解決: "},{"text":"SUCCESS","color": "green"},{"text":" : "},{"score":{"name": "$cost","objective": "ui_temp"}},{"text":"<="},{"score":{"name": "@s","objective": "ui_tmw272_mana"}}]
execute unless score $cost ui_temp <= @s ui_tmw272_mana run tellraw @s[scores={ui_tmw601_accessory=5007}] ["",{"text":"> ","color":"gray","bold": true},{"text":"タイプ3解決: "},{"text":"FAILURE","color": "red"},{"text":" : "},{"score":{"name": "$cost","objective": "ui_temp"}},{"text":"!<="},{"score":{"name": "@s","objective": "ui_tmw272_mana"}}]
