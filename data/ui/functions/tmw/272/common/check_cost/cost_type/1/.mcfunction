...
# 最小値と最大値も封印で増加する
execute if score $broadcast_type ui_temp matches 1 run scoreboard players operation $cost_min ui_temp += @s ui_tmw272_seal
execute if score $broadcast_type ui_temp matches 1 run scoreboard players operation $cost_max ui_temp += @s ui_tmw272_seal
