...
data modify storage ui:temp temp.mods set from storage ui:temp cost_mods
...
execute unless data storage ui:temp card.cost_max run scoreboard players operation $cost ui_temp < $cost_max ui_temp
