...
execute at @s anchored eyes positioned ^ ^ ^ facing entity @e[limit=1,tag=ui_temp_player] eyes positioned ^ ^ ^1 facing entity @s eyes positioned as @e[limit=1,tag=ui_temp_player] positioned ^ ^ ^0.5 run summon marker ~ ~ ~ {Tags:["ui_temp_marker","ui_temp_marker_unpower"]}
