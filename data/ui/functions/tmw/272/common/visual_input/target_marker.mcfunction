...
execute at @s anchored eyes positioned ^ ^ ^ facing entity @e[limit=1,tag=ui_temp_player] feet positioned ^ ^ ^1 facing entity @s eyes as @e[limit=1,tag=ui_temp_player] positioned ~ ~1.62 ~ positioned ^ ^ ^0.5 run summon marker ~ ~ ~ {Tags:["ui_temp_marker","ui_temp_marker_unpower"]}
