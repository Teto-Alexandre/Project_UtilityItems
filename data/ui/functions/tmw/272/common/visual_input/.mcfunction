...
# ターゲット出来るエンティティを周囲に表示
    ...
    execute at @e[tag=ui_temp_marker,tag=!ui_temp_target2] run particle dust 1 0 0 0.2 ~ ~1.62 ~ 0 0 0 0 1 normal @s
    execute if score @s ui_tmw272_surehit matches 1.. at @e[tag=ui_temp_target2] run particle dust 0 0.5 1 0.1 ~ ~1.62 ~ 0.01 0.01 0.01 0 3 normal @s
    execute at @e[tag=ui_temp_target2] run particle dust 0 1 1 0.2 ~ ~1.62 ~ 0 0 0 0 1 normal @s
