...
execute unless data storage ui:temp temp.effect.just_list run function ui:tmw/272/common/draw/just_list
...
execute if entity @e[tag=tmw272_temp_steal,type=!player] if data storage ui:temp temp.draw_card.tag.tmw{id:272,type:1} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand append from storage ui:temp temp.draw_card
execute if entity @e[tag=tmw272_temp_steal,type=!player] if data storage ui:temp temp.draw_card.tag.tmw{id:272,type:1} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand[-1].tag.IsCG1 set value 1
execute if entity @e[tag=tmw272_temp_steal,type=!player] run function oh_my_dat:please
execute unless entity @e[tag=tmw272_temp_steal] if entity @s[type=!player] if data storage ui:temp temp.draw_card.tag.tmw{id:272,type:1} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand append from storage ui:temp temp.draw_card
execute unless entity @e[tag=tmw272_temp_steal] if entity @s[type=!player] if data storage ui:temp temp.draw_card.tag.tmw{id:272,type:1} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand[-1].tag.IsCG1 set value 1
