...
execute if data storage ui:temp temp.draw_card.tag.tmw.cg.deck_effect.list_self run data modify storage ui:temp temp.draw_card.tag.tmw.cg.deck_effect.list set value []
execute if data storage ui:temp temp.draw_card.tag.tmw.cg.deck_effect.list_self run data modify storage ui:temp temp.draw_card.tag.tmw.cg.deck_effect.list append from storage ui:temp temp.draw_card
