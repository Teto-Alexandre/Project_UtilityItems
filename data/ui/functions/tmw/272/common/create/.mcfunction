...
#
execute store result score $cg1_list_count ui_temp run data get storage ui:cg1 temp.list
execute if score $cg1_common_draw_num ui_temp matches 1.. if score $cg1_common_draw_inventory ui_temp <= @s ui_tmw272_hand_num_limit if score $cg1_common_draw_type ui_temp matches 0..1 run function ui:tmw/272/common/create/0
