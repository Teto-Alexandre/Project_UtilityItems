...
execute if entity @s[type=!player] if data storage ui:cg1 temp.list[0].tag.tmw{id:272,type:1} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand append from storage ui:cg1 temp.list[0]
execute if entity @s[type=!player] if data storage ui:cg1 temp.list[0].tag.tmw{id:272,type:1} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.hand[-1].tag.IsCG1 set value 1
