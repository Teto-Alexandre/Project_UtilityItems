...
execute if score $time_limit_turn ui_temp matches ..1 run scoreboard players set $check_death_effect ui_temp 1

execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ui.cg1.DeathEffects[0].time_limit_turn int 1 run scoreboard players remove $time_limit_turn ui_temp 1