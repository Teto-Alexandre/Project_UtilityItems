scoreboard players set $check_death_effect ui_temp 0

#
#tellraw @s[scores={ui_tmw601_accessory=5007}] ["",{"text":"> ","color":"gray","bold": true},{"text":">@s ","color":"green"},{"text":" CHECK_death_EFFECT の解決を行います"}]
...
# ディレイタイプ別に参照
execute if score $time_limit_turn ui_temp matches 1.. run function ui:tmw/272/common/check_death_effect/time2
