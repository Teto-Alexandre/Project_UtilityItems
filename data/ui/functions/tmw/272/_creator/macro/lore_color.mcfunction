...
execute if score $edited ui_temp matches 0 run function ui:tmw/272/_creator/macro/lore_re/
execute if score $edited ui_temp matches 1 run data modify storage ui:temp temp.lore_re append from storage ui:temp temp.lore[0]
