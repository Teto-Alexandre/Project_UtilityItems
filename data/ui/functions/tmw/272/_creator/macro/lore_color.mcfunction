...
scoreboard players set $edited ui_temp 0
...
execute if score $edited ui_temp matches 0..1 run function ui:tmw/272/_creator/macro/lore_re/
execute if score $edited ui_temp matches 2 run data modify storage ui:temp temp.lore_re append from storage ui:temp temp.lore[0]
