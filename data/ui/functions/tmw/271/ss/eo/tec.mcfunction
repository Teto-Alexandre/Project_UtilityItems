#> ui:tmw/271/ss/eo/tec
#
# #タレットを管理する
#
# @within function ui:tmw/271/ss/s_team_id
...
execute as @e[limit=1,tag=ui_temp_team_control] run function ui:tmw/271/ss/eo/idc
...
# 再帰
execute if entity @e[tag=ui_tec] as @e[limit=1,tag=ui_tec] run function ui:tmw/271/ss/eo/tec
