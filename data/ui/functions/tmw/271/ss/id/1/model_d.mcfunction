data modify entity @e[tag=ui_temp_obj,tag=tmw_271_display1,limit=1] Pose merge value {Head:[0.0f,1.0f,0.0f]}
data modify entity @e[tag=ui_temp_obj,tag=tmw_271_display2,limit=1] Pose merge value {Head:[0.0f,1.0f,0.0f]}
data modify entity @e[tag=ui_temp_obj,tag=tmw_271_display3,limit=1] Pose merge value {Head:[0.0f,1.0f,0.0f]}
