...
# メニュー表示
    ...
    item replace entity @s enderchest.15 with gray_stained_glass_pane{CustomModelData:120002,display:{Name:'{"text":"[リゲイン]","color":"gray","italic":false}',Lore:['{"text":"何の効果もない代わりに発動しやすい","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    ...
    item replace entity @s enderchest.22 with gray_stained_glass_pane{CustomModelData:121452,display:{Name:'{"text":"[マルチミサイル]","color":"gray","italic":false}',Lore:['{"text":"大量のミサイルを発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
