...
# メニュー表示
    ...
    item replace entity @s enderchest.15 with gray_stained_glass_pane{CustomModelData:121258,display:{Name:'{"text":"[リゲイン]","color":"gray","italic":false}',Lore:['{"text":"何の効果もない代わりに発動しやすい","color":"aqua","italic":false}','{"text":"準備完了の通知が無く気付かれにくい","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    ...
    item replace entity @s enderchest.20 with gray_stained_glass_pane{CustomModelData:121351,display:{Name:'{"text":"[メガホンレーザー]","color":"gray","italic":false}',Lore:['{"text":"壁を貫通する攻撃を行う","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.21 with gray_stained_glass_pane{CustomModelData:121451,display:{Name:'{"text":"[スーパーショット]","color":"gray","italic":false}',Lore:['{"text":"縦に長いショットを発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.22 with gray_stained_glass_pane{CustomModelData:121452,display:{Name:'{"text":"[マルチミサイル]","color":"gray","italic":false}',Lore:['{"text":"大量の降り注ぐミサイルを発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.23 with gray_stained_glass_pane{CustomModelData:121453,display:{Name:'{"text":"[トライアングル]","color":"gray","italic":false}',Lore:['{"text":"3方向にショットを発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.24 with gray_stained_glass_pane{CustomModelData:121454,display:{Name:'{"text":"[ハイドロポンプ]","color":"gray","italic":false}',Lore:['{"text":"一直線にショットを発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
