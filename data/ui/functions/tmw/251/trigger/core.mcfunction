...
#
execute if score @s ui_trg matches 1 run function ui:tmw/251/trigger/activate/main

execute if score @s ui_trg matches 2 run execute at @e[tag=tmw_251_2] run fill ~-1 ~2 ~-1 ~1 ~2 ~1 white_wool

execute if score @s ui_trg matches 3 run tag @e[tag=tmw_251_2,tag=!stone,limit=6,sort=random] add stone
...
execute if score @s ui_trg matches 4 run execute at @e[tag=tmw_251_2,limit=50,sort=random] run fill ~ ~2 ~ ~ ~2 ~ oak_planks replace white_wool
...
execute if score @s ui_trg matches 99 run execute at @e[tag=tmw_251_2] run fill ~-1 ~2 ~-1 ~1 ~10 ~1 air
execute if score @s ui_trg matches 99 run kill @e[tag=tmw_251]
