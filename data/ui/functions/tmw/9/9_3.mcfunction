...
execute at @s[scores={ui_tc=41..}] positioned ~ ~-1 ~ if entity @e[distance=..1,type=!#ui:notmob] run summon minecraft:armor_stand ~ ~1 ~ {Marker:1b,NoGravity:1b,Invisible:1b,Tags:["tmw_9_9"]}
execute at @s[scores={ui_tc=41..}] positioned ~ ~-1 ~ if entity @e[distance=..1,type=!#ui:notmob] run tag @s add tmw_9_3_2
