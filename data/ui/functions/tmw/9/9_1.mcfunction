...
execute at @s[scores={ui_tc=5..}] positioned ~ ~-1 ~ run tag @e[distance=..2,predicate=ui:load_unhurtable] add tmw_9_2
execute at @s[scores={ui_tc=5..}] positioned ~ ~-1 ~ as @e[distance=..2,predicate=ui:load_unhurtable] at @s run particle dust 1 0 1 2 ~ ~3 ~ 0 0 0 0 1 force @a[scores={ui_tmw_id=9}]
...
execute at @s[scores={ui_tc=5..}] positioned ~ ~-1 ~ if entity @e[distance=..2,predicate=ui:load_unhurtable] run tag @s remove tmw_9_2_3
