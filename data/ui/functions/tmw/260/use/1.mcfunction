#
execute if score $mode ui_temp matches 1 run tellraw @s [{"text":"System","color":"gray"},{"text":"> ","color":"green"},{"text":"矢","color":"white"}]
...
execute if score $mode ui_temp matches 2 run tellraw @s [{"text":"System","color":"gray"},{"text":"> ","color":"green"},{"text":"落下","color":"white"}]
execute if score $mode ui_temp matches 2 as @e[distance=..10] run data merge entity @s {FallDistance:2147483647}

execute if score $mode ui_temp matches 3 run tellraw @s [{"text":"System","color":"gray"},{"text":"> ","color":"green"},{"text":"即死","color":"white"}]
