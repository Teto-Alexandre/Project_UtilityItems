...
# ダメージ本体
    ...
    scoreboard players operation $final_damage ui_temp = $damage ui_temp
    scoreboard players operation $final_damage ui_temp *= $speed ui_temp
    execute store result storage tds: temp.Damage float 0.01 run scoreboard players get $final_damage ui_temp
