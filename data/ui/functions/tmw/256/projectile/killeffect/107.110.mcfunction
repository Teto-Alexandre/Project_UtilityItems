...
#
summon item ~ ~ ~ {Tags:["ui_temp_this_plus","tmw_256_sub","ui_refd"],NoGravity:1b,Invulnerable:1b,Item:{id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{tmw:{type:399},CustomModelData:120001}},PickupDelay:32767s,Motion:[0.0d,0.0d,0.0d]}
