...
# 弾を出す
    execute anchored eyes run summon minecraft:armor_stand ^ ^ ^ {Marker:1b,NoGravity:1b,Invisible:1b,Tags:["tds.attack","ui","ui_proj","tmw_256","ui_temp_unpower"],ArmorItems:[{id:"minecraft:stone",Count:1b,tag:{display:{Name:'{"text":"null"}'}}},{},{},{}]}
    ...
    execute if score $mod ui_temp matches 1.. run function ui:tmw/256/square_shuffle
...
# ショットガン.lp
    ...
    execute if score $multishot ui_temp matches 1.. run function ui:tmw/256/attack/shot/loop