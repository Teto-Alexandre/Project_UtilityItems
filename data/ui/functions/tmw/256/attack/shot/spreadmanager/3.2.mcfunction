...
# 弾を出す
    function ui:tmw/256/attack/shot/fire_straight
...
# ショットガン.lp
    ...
    execute if score $multishot ui_temp matches 1.. at @e[tag=ui_marker] run function ui:tmw/256/attack/shot/spreadmanager/3.2