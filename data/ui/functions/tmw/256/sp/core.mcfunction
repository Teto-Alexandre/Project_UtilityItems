...
execute if score $activator ui_temp matches 101..200 run function ui:tmw/256/activator/throw
execute if score $activator ui_temp matches 201..300 run function ui:tmw/256/activator/here
execute if score $activator ui_temp matches 301..400 at @s run function ui:tmw/256/activator/static
execute if score $activator ui_temp matches 401..500 at @s run function ui:tmw/256/activator/weapon
...
execute if score $sptype ui_temp matches 258 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"リゲイン","color":"gold"},{"text":"]","color":"gray"},{"text":"を発動しました！","color":"white"}]
...
execute if score $sptype ui_temp matches 459 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"ロケッティア","color":"gold"},{"text":"]","color":"gray"},{"text":"を発動しました！","color":"white"}]
execute if score $sptype ui_temp matches 460 run tellraw @a [{"selector":"@s"},{"text":"が","color":"white"},{"text":"[","color":"gray"},{"text":"ナイスダマ","color":"gold"},{"text":"]","color":"gray"},{"text":"を発動しました！","color":"white"}]
