...
# タグチェック
    execute if entity @s[tag=tmw_256_king] run function ui:tmw/256/amp/king

# レーザーサイト
    execute if score $model ui_temp matches 110811 run function ui:tmw/256/constant/laser
...
# チームカラーに合わせた防具を装備
    execute if score $team ui_temp matches 1 if entity @s[nbt=!{Inventory:[{Slot:100b,tag:{display:{color:8247039}}}]}] run function ui:tmw/256/constant/armor/eq1
    execute if score $team ui_temp matches 2 if entity @s[nbt=!{Inventory:[{Slot:100b,tag:{display:{color:16752832}}}]}] run function ui:tmw/256/constant/armor/eq2
    execute if score $team ui_temp matches 3 if entity @s[nbt=!{Inventory:[{Slot:100b,tag:{display:{color:16646013}}}]}] run function ui:tmw/256/constant/armor/eq3
    execute if score $team ui_temp matches 4 if entity @s[nbt=!{Inventory:[{Slot:100b,tag:{display:{color:10551208}}}]}] run function ui:tmw/256/constant/armor/eq4
