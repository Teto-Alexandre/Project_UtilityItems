...
# スリップダメージ
    ...
    execute store result score $health ui_temp run data get entity @s Health -0.06
    data merge storage tds: {temp:{Damage:300.00,DamageType:1,DeathMessage:-1,WeaponName:"",EPF:-1,BypassArmor:0,BypassResistance:false}}
