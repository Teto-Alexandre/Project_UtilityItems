...
#
    ...
    execute if score $temp ui_temp matches 1.. if score @s ui_st2 > $chargekeep ui_temp run function ui:tmw/256/constant/charge_cancel2
    execute if score $temp ui_temp matches ..0 run function ui:tmw/256/constant/charge_cancel3