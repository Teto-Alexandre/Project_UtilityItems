# 今の状態を観測
    scoreboard players operation $temp ui_temp = $tmw256.hand ui_world
...
# 有効化
    execute if score $temp ui_temp matches 0 run scoreboard players set $tmw256.hand ui_world 1
...
# 無効化
    execute if score $temp ui_temp matches 1 run scoreboard players set $tmw256.hand ui_world 0
