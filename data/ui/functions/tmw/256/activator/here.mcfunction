...
# リコール
    execute if score $activator ui_temp matches 201 run function ui:tmw/256/activator/here/201
...
# トーテム
    execute if score $activator ui_temp matches 257 run function ui:tmw/256/misc/temp_team
