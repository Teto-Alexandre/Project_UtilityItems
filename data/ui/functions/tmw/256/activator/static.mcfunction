summon item ~ ~ ~ {Tags:["ui_temp_this","tmw_256_sub","ui_refd"],Invulnerable:1b,Item:{id:"minecraft:gray_stained_glass_pane",Count:1b,tag:{CustomModelData:120001}},PickupDelay:32767s}
