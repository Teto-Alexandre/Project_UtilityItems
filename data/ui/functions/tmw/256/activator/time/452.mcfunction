...
execute if score $time ui_temp matches 0 anchored eyes positioned ^ ^ ^ run function ui:tmw/256/activator/time/452.0
execute if score $time ui_temp matches 1 anchored eyes positioned ^ ^ ^ run function ui:tmw/256/activator/time/452.1
