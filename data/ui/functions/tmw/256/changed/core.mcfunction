...
execute if score $subtime ui_temp matches 0 if score $sptime ui_temp matches 0 run function ui:tmw/256/changed/bar_ink
execute if score $subtime ui_temp matches 1.. if score $sptime ui_temp matches 0 run function ui:tmw/256/changed/bar_sub
execute if score $sptime ui_temp matches 1.. run function ui:tmw/256/changed/bar_sp
