...
# ループ管理
    ...
    execute as @e[tag=ui_temp_marker] at @s run function ui:tmw/256/sub/explosive/153/tick.line
...
execute if score $count ui_temp matches 1.. rotated ~90 ~ run function ui:tmw/256/sub/explosive/153/tick.rotator