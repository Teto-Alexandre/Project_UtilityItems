...
# 常時実行
    ...
    execute if score @s ui_uses matches 60.. run tag @s add ui_256_sub_explode

# 処理終了
    execute if entity @s[tag=ui_256_sub_explode] run function ui:tmw/256/sub/explosive/102/end