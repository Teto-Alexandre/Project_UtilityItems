# 弾を出す
    summon minecraft:armor_stand ^ ^ ^ {Marker:1b,NoGravity:1b,Invisible:1b,Tags:["tds.attack","ui","ui_proj","tmw_256","ui_temp_unpower","tmw_256_deathmessage_14"],ArmorItems:[{id:"minecraft:stone",Count:1b,tag:{display:{Name:'{"text":"null"}'}}},{},{},{}]}
    summon minecraft:marker ^ ^ ^1 {Tags:["ui","ui_marker"]}
    scoreboard players set $mod ui_temp 500
    function ui:tmw/256/square_shuffle
