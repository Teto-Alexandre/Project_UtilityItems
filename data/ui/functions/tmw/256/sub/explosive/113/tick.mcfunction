...
# 常時実行
    ...
    execute if score @s ui_is matches 1.. if score $team ui_temp matches 1 at @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1] run particle dust 0.5 1 1 3 ~ ~0.5 ~ 0 0 0 0 1 force
    execute if score @s ui_is matches 1.. if score $team ui_temp matches 2 at @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1] run particle dust 1 0.5 1 3 ~ ~0.5 ~ 0 0 0 0 1 force
    execute if score @s ui_is matches 1.. if score $team ui_temp matches 3 at @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1] run particle dust 1 1 0.5 3 ~ ~0.5 ~ 0 0 0 0 1 force
    execute if score @s ui_is matches 1.. if score $team ui_temp matches 4 at @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1] run particle dust 0.5 1 0.5 3 ~ ~0.5 ~ 0 0 0 0 1 force
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches ..20 run data merge entity @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1,limit=1] {NoAI:1b}
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches 10 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 1 1.8 0
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches 12 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 1 1.8 0
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches 14 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 1 1.8 0
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches 16 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 1 1.8 0
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches 18 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 1 1.8 0
    execute if entity @s[tag=ui_256_sub_stop] if score @s ui_is matches 20 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 1 1.8 0
...
# 処理終了
    ...
    #ダメージ計算
    execute if entity @s[tag=ui_256_sub_first] store result score $temp ui_temp run data get entity @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1,limit=1] Health 10
    ...
    execute if entity @s[tag=ui_256_sub_first] run data merge entity @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1,limit=1] {Health:1000f}

#
    execute if score @s ui_is matches 22.. at @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1] if entity @e[distance=..1.5,tag=!ui_temp_team,predicate=ui:load_unhurtable] run scoreboard players set @s ui_is 21

# 処理終了（消える）
    execute if entity @s[tag=ui_256_sub_explode] at @e[tag=ui_temp_obj,tag=tmw_256_sub_113_1] run function ui:tmw/256/sub/explosive/113/end
