...
# それぞれの起爆
    ...
    execute if score $type ui_temp matches 102 run function ui:tmw/256/sub/explosive/102/tick
    execute if score $type ui_temp matches 103 run function ui:tmw/256/sub/explosive/103/tick
    execute if score $type ui_temp matches 104 run function ui:tmw/256/sub/explosive/104/tick
    execute if score $type ui_temp matches 105 run function ui:tmw/256/sub/explosive/105/tick
    execute if score $type ui_temp matches 106 run function ui:tmw/256/sub/explosive/106/tick
    execute if score $type ui_temp matches 107 run function ui:tmw/256/sub/explosive/107/tick
    execute if score $type ui_temp matches 108 run function ui:tmw/256/sub/explosive/108/tick
    execute if score $type ui_temp matches 109 run function ui:tmw/256/sub/explosive/109/tick
    execute if score $type ui_temp matches 110 run function ui:tmw/256/sub/explosive/110/tick
    execute if score $type ui_temp matches 111 run function ui:tmw/256/sub/explosive/111/tick
    execute if score $type ui_temp matches 112 run function ui:tmw/256/sub/explosive/112/tick
    execute if score $type ui_temp matches 113 run function ui:tmw/256/sub/explosive/113/tick
    execute if score $type ui_temp matches 114 run function ui:tmw/256/sub/explosive/114/tick
    execute if score $type ui_temp matches 115 run function ui:tmw/256/sub/explosive/115/tick

    execute if score $type ui_temp matches 151 run function ui:tmw/256/sub/explosive/151/tick
    execute if score $type ui_temp matches 152 run function ui:tmw/256/sub/explosive/152/tick
    execute if score $type ui_temp matches 153 run function ui:tmw/256/sub/explosive/153/tick

    execute if score $type ui_temp matches 301 run function ui:tmw/256/sub/explosive/301/tick
    execute if score $type ui_temp matches 351 run function ui:tmw/256/sub/explosive/351/tick
    execute if score $type ui_temp matches 399 run function ui:tmw/256/sub/explosive/399/tick
...
# 投擲物パーティクル
    ...
    execute if entity @s[tag=!tmw256_sub_nopoint] as @a if score @s ui_id = $id ui_temp run scoreboard players operation @s ui_paint += $temp ui_temp
...
# 水対策
    execute if block ~ ~-0.5 ~ #ui:liq run tag @s add ui_256_sub_explode