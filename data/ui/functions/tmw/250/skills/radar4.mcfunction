...
#
    ...
    execute as @e[tag=ui_temp_near,tag=ui_common_mine_square_bomb,sort=random,limit=3] run tag @s add ui_temp_bomb
...
#
    ...
    execute if block ~ ~ ~ gray_stained_glass as @e[tag=ui_temp_mine_square,tag=!ui_common_mine_square_bomb,distance=0.1..1.5] run tag @s add ui_common_mine_square_press
    execute if block ~ ~ ~ black_stained_glass as @e[tag=ui_temp_mine_square,tag=!ui_common_mine_square_bomb,distance=0.1..1.5] run tag @s add ui_common_mine_square_press