# ダメージを数値表示
    ...
    scoreboard players operation $Word2 tds_dmg %= $10 tds_dmg
    execute in overworld run data modify block 0 1 0 Text1 set value '[{"text":"+","color":"green"},{"score":{"name":"$Word1","objective":"tds_dmg"}},{"text":"."},{"score":{"name":"$Word2","objective":"tds_dmg"}}]'
