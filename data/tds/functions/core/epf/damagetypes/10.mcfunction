...
# 頭
    execute store result score $Temp tds_dmg run data get storage tds:temp armor_head.tmw.ench[{id:"electro_protection"}].lvl 2
    scoreboard players operation $EPF tds_dmg += $Temp tds_dmg
# 胸
    execute store result score $Temp tds_dmg run data get storage tds:temp armor_chest.tmw.ench[{id:"electro_protection"}].lvl 2
    scoreboard players operation $EPF tds_dmg += $Temp tds_dmg
# 脚
    execute store result score $Temp tds_dmg run data get storage tds:temp armor_legs.tmw.ench[{id:"electro_protection"}].lvl 2
    scoreboard players operation $EPF tds_dmg += $Temp tds_dmg
# 足
    execute store result score $Temp tds_dmg run data get storage tds:temp armor_feet.tmw.ench[{id:"electro_protection"}].lvl 2
    scoreboard players operation $EPF tds_dmg += $Temp tds_dmg
