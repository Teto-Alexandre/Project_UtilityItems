# ダメージを数値表示
    ...
    execute in overworld run data modify block 0 1 0 front_text.messages[0] set value '[{"score":{"name":"$Word1","objective":"tds_dmg"}},{"text":"."},{"score":{"name":"$Word2","objective":"tds_dmg"}}]'
