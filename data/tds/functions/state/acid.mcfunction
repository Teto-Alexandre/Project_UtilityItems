...
#ダメージ本体
    execute if score @s tds_acid matches 20.. run data merge storage tds: {Damage:1.0f,DamageType:2,DeathMessage:3,WeaponName:"",EPF:-1,BypassArmor:-1,BypassResistance:false,DisableParticle:true}
