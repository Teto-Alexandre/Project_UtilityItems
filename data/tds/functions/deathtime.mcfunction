...
execute if score $temp ui_temp matches 16..19 at @s run particle dust 1 0.5 1 1 ~ ~ ~ 2 2 2 0 40 force
execute if score $temp ui_temp matches 16..19 at @s run particle block pink_concrete ~ ~ ~ 2 2 2 0 40 force
execute if score $temp ui_temp matches 26..29 at @s run fill ~-3 ~-3 ~-3 ~3 ~3 ~3 light_blue_wool replace #ui:wools
execute if score $temp ui_temp matches 26..29 at @s run particle dust 0.5 1 1 1 ~ ~ ~ 2 2 2 0 40 force
execute if score $temp ui_temp matches 26..29 at @s run particle block light_blue_concrete ~ ~ ~ 2 2 2 0 40 force